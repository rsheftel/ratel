...
namespace ZedGraph {
    ...
    [Serializable] public class StockPt : PointPair {
        ...
        public StockPt(
            ...
            Close = close;
            Vol = vol;
            initVirtualMemberCallInConstructor(Missing);
            Tag = tag;
        }

        void initVirtualMemberCallInConstructor(double value) {
            ColorValue = value;
        }
        ...
        protected StockPt(SerializationInfo info, StreamingContext context)
            ...
            initVirtualMemberCallInConstructor(info.GetDouble("ColorValue"));
        }
