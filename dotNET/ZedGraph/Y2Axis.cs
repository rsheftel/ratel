...
namespace ZedGraph {
    ...
    [Serializable] public class Y2Axis : Axis, ICloneable {
        #region Defaults
        /// <summary>
        ...
        internal override float CalcCrossShift(GraphPane pane) {
            ...
            if (!_crossAuto) return pane.XAxis.Scale.Transform(effCross) - pane.XAxis.Scale._maxPix;
            return 0;
        }
