...
namespace ZedGraph {
    ...
    /// represents white.
    /// </remarks>
    [Serializable] public struct HSBColor {
        /// <summary>
        ...
        public static Color ToRGB(HSBColor hsbColor) {
            ...
            var fraction = hsbColor.H / 42.5 - sector;

            var sFrac = hsbColor.S / 255.0;
        ...
        public static HSBColor FromRGB(Color rgbColor) {
            ...
            var hsbColor = new HSBColor(rgbColor.A, 0, 0, 0) {B = ((byte) (max * 255.0 + 0.5))};

            var delta = max - min;

            if (max != 0.0) hsbColor.S = (byte) (delta / max * 255.0 + 0.5);
            else {
                hsbColor.S = 0;
                hsbColor.H = 0;
                return hsbColor;
            ...
            if (hsbColor.H < 0) hsbColor.H += 255;
