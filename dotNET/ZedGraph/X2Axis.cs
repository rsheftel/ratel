...
namespace ZedGraph {
    ...
    [Serializable] public class X2Axis : Axis, ICloneable {
        #region Defaults
        /// <summary>
        ...
        internal override float CalcCrossShift(GraphPane pane) {
            ...
            if (!_crossAuto) return pane.YAxis.Scale.Transform(effCross) - pane.YAxis.Scale._maxPix;
            return 0;
        }
