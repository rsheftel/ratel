...
namespace ZedGraph {
    ...
    [Serializable] public class ArrowObj : LineObj, ICloneable {
        #region Fields
        /// <summary>
        ...
        public override void Draw(Graphics g, PaneBase pane, float scaleFactor) {
            ...
            if (pix1.X <= -10000 || pix1.X >= 100000 || pix1.Y <= -100000 || pix1.Y >= 100000 || pix2.X <= -10000 ||
                pix2.X >= 100000 || pix2.Y <= -100000 || pix2.Y >= 100000) return;
            ...
            using (var pen = _line.GetPen(pane, scaleFactor)) //new Pen( _color, pane.ScaledPenWidth( _penWidth, scaleFactor ) ) )
                ...
                if (_isArrowHead) {
                    ...
                    using (var brush = new SolidBrush(_line._color)) // render the arrowhead
                        g.FillPolygon(brush, polyPt);
                } else g.DrawLine(pen, 0, 0, length, 0);
