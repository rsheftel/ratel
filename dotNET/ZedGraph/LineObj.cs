...
namespace ZedGraph {
    ...
    [Serializable] public class LineObj : GraphObj, ICloneable {
        #region Fields
        /// <summary>
        ...
        public override void Draw(Graphics g, PaneBase pane, float scaleFactor) {
            ...
            using (var pen = _line.GetPen(pane, scaleFactor)) //new Pen( _line._color, pane.ScaledPenWidth( _line._width, scaleFactor ) ) )
        ...
        public override void GetCoords(
            ...
            if (pixRect.Right == 0) pixRect.Width = 1;
            var angle = (float) Math.Atan(
                (pixRect.Top - pixRect.Bottom) /
