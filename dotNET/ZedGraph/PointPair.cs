...
namespace ZedGraph {
    ...
    [Serializable] public class PointPair : PointPairBase, ICloneable {
    ...
    /// </summary>
        ...
        public class PointPairComparer : IComparer<PointPair> {
            ...
            public int Compare(PointPair l, PointPair r) {
                ...
                if (lVal == Missing || Double.IsInfinity(lVal) || Double.IsNaN(lVal)) l = null;
                if (rVal == Missing || Double.IsInfinity(rVal) || Double.IsNaN(rVal)) r = null;

                if ((l == null && r == null) || (Math.Abs(lVal - rVal) < 1e-100)) return 0;
                if (l == null) return -1;
                if (r == null) return 1;
                return lVal < rVal ? -1 : 1;
            }
        ...
        public class PointPairComparerY : IComparer<PointPair> {
            ...
            public int Compare(PointPair l, PointPair r) {
                ...
                if (Math.Abs(lY - rY) < .000000001) return 0;
        ...
        public override bool Equals(object obj) {
            ...
            if (rhs != null) return X == rhs.X && Y == rhs.Y && Z == rhs.Z;
            return false;
        }
