...
namespace ZedGraph {
    ...
    [Serializable] public class JapaneseCandleStickItem : CurveItem, ICloneable {
        #region Fields
        /// <summary>
        ...
        /// </summary>
        /// 
        readonly JapaneseCandleStick _stick;
        #endregion
        #region Properties
        /// <summary>
        ...
        protected JapaneseCandleStickItem(SerializationInfo info, StreamingContext context)
            ...
            _stick = (JapaneseCandleStick) info.GetValue(
                "stick",
        ...
        public override void DrawLegendKey(
            ...
            using (var pen = new Pen(_stick.Color, _stick._width))
                _stick.Draw(
                    g,
                    pane,
