...
namespace ZedGraph {
    ...
    [Serializable] public class LineItem : CurveItem, ICloneable {
        #region Fields
        /// <summary>
        ...
        public LineItem(string label, IPointList points, Color color, SymbolType symbolType, float lineWidth)
            ...
            if (lineWidth == 0) _line.IsVisible = false;
            else _line.Width = lineWidth;
        ...
        public override bool GetCoords(GraphPane pane, int i, out string coords) {
            ...
            if (!pane.Chart.Rect.Contains(pixPt)) return false;
