...
namespace ZedGraph {
    ...
    [Serializable] public class PaneList : List<GraphPane>, ICloneable {
        #region Constructors
        /// <summary>
        ...
        public PaneList(IEnumerable<GraphPane> rhs) {
        ...
        /// </param>
        protected PaneList(SerializationInfo info) {
...
*/
        ...
        public int IndexOf(string title) {
            ...
            foreach (var pane in this) {
                if (String.Compare(pane.Title.Text, title, true) == 0) return index;
                index++;
            }
        ...
        public int IndexOfTag(string tagStr) {
            ...
            foreach (var pane in this) {
                if (pane.Tag is string &&
                    String.Compare((string) pane.Tag, tagStr, true) == 0) return index;
                index++;
            }
