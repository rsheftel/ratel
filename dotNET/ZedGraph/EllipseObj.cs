...
namespace ZedGraph {
    ...
    [Serializable] public class EllipseObj : BoxObj, ICloneable {
        #region Constructors
        ...
        public override void Draw(Graphics g, PaneBase pane, float scaleFactor) {
            ...
            if (_fill.IsVisible) using (var brush = _fill.MakeBrush(pixRect)) g.FillEllipse(brush, pixRect);

            if (_border.IsVisible) using (var pen = _border.GetPen(pane, scaleFactor)) g.DrawEllipse(pen, pixRect);
        }
