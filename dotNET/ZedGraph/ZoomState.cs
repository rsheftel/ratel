...
namespace ZedGraph {
    ...
    public class ZoomState : ICloneable {
        ...
        /// scale range state.
        /// </summary>
        readonly StateType _type;

        /// <summary>
        /// <see cref="ScaleState"/> objects to store the state data from the axes.
        /// </summary>
        readonly ScaleState _x2Axis;
        /// <summary>
        /// <see cref="ScaleState"/> objects to store the state data from the axes.
        /// </summary>
        readonly ScaleState _xAxis;
        readonly ScaleStateList _y2Axis;
        readonly ScaleStateList _yAxis;
