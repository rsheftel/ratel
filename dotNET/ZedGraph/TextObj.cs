...
namespace ZedGraph {
    ...
    [Serializable] public class TextObj : GraphObj, ICloneable {
        #region Fields
        /// <summary>
		...
		*/
        ...
        public FontSpec FontSpec {
            ...
            set {
                if (value == null) throw new ArgumentNullException("Uninitialized FontSpec in TextObj");
                _fontSpec = value;
            }
        }
        #endregion
        ...
        void Init(string text) {
            ZedGraphUtil.possibleBug("removed useless assignment to 'text' - should probably be _text.");
        ...
        public override void Draw(Graphics g, PaneBase pane, float scaleFactor) {
            ...
            // fill elements
            if (pix.X > -100000 && pix.X < 100000 && pix.Y > -100000 && pix.Y < 100000) //if ( this.layoutSize.IsEmpty )
