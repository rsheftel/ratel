...
namespace ZedGraph {
    partial class ZedGraphControl {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Determines which mouse button is used as the primary for zooming")] public MouseButtons
            ZoomButtons {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Determines which mouse button is used as the secondary for zooming")] public MouseButtons
            ZoomButtons2 {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Determines which modifier key used as the primary for zooming")] public Keys ZoomModifierKeys {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(Keys.None),
         Description("Determines which modifier key used as the secondary for zooming")] public Keys ZoomModifierKeys2 {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(MouseButtons.Left),
         Description("Determines which mouse button is used as the primary for panning")] public MouseButtons PanButtons {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Determines which mouse button is used as the secondary for panning")] public MouseButtons
            PanButtons2 {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Determines which modifier key is used as the primary for panning")] public Keys PanModifierKeys {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(Keys.None),
         Description("Determines which modifier key is used as the secondary for panning")] public Keys PanModifierKeys2 {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Specify mouse button for point editing")] public MouseButtons EditButtons {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Specify modifier key for point editing")] public Keys EditModifierKeys {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(MouseButtons.Left),
         Description("Specify mouse button for curve selection")] public MouseButtons SelectButtons {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Specify modifier key for curve selection")] public Keys SelectModifierKeys {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Specify modifier key for append curve selection")] public Keys SelectAppendModifierKeys {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(MouseButtons.Left),
         Description("Specify mouse button for clicking on linkable objects")] public MouseButtons LinkButtons {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(Keys.Alt),
         Description("Specify modifier key for clicking on linkable objects")] public Keys LinkModifierKeys {
        ...
        [Bindable(false), Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public MasterPane MasterPane {
		...
		*/
        ...
        [
            ...
            get {
                ...
                lock (this) {
                    if (_masterPane != null && _masterPane.PaneList.Count > 0) return _masterPane[0];                     
                    return null;
                }
            }
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(false),
         Description("true to force all objects to be draw in anti-alias mode")] public bool IsAntiAlias {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true), DefaultValue(false),
         Description("true to display tooltips when the mouse hovers over data points")] public bool IsShowPointValues { get; set; }
        ...
        /// </remarks>
        [Bindable(true), Category("Display"), NotifyParentProperty(true), DefaultValue(false),
         Description("true to display tooltips showing the current mouse position within the Chart area")] public bool
            IsShowCursorValues { get; set; }
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true), DefaultValue(false),
         Description("true to allow horizontal editing by alt-left-click-drag")] public bool IsEnableHEdit { get; set; }
        ...
        /// </remarks>
        [Bindable(true), Category("Display"), NotifyParentProperty(true), DefaultValue(false),
         Description("true to allow vertical editing by alt-left-click-drag")] public bool IsEnableVEdit { get; set; }
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to allow horizontal and vertical zooming by left-click-drag")] public bool IsEnableZoom {
            set {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to allow horizontal zooming by left-click-drag")] public bool IsEnableHZoom {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to allow vertical zooming by left-click-drag")] public bool IsEnableVZoom {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to allow zooming with the mouse wheel")] public bool IsEnableWheelZoom {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to allow horizontal panning by middle-mouse-drag or shift-left-drag")] public bool
            IsEnableHPan {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to allow vertical panning by middle-mouse-drag or shift-left-drag")] public bool IsEnableVPan {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to enable the right mouse button context menu")] public bool IsShowContextMenu {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to show a message box after a 'Copy' context menu action completes")] public bool
            IsShowCopyMessage {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("Provides access to the SaveFileDialog for the 'Save As' menu item")] public SaveFileDialog
            SaveFileDialog {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to preserve the displayed aspect ratio when printing")] public bool IsPrintKeepAspectRatio {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to resize to fill the page when printing")] public bool IsPrintFillPage {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(true),
         Description("true to force font and pen width scaling when printing")] public bool IsPrintScaleAll {
        ...
        /// </remarks>
        [Bindable(true), Category("Display"), NotifyParentProperty(true), DefaultValue(false),
         Description("true to automatically set the scroll bar range to the actual data range")] public bool
            IsAutoScrollRange { get; set; }
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(false),
         Description("true to display the horizontal scroll bar")] public bool IsShowHScrollBar {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(false),
         Description("true to display the vertical scroll bar")] public bool IsShowVScrollBar {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(false),
         Description("true to force the X axis ranges for all GraphPanes to match")] public bool IsSynchronizeXAxes {
            get { return _isSynchronizeXAxes; }
            set {
                if (_isSynchronizeXAxes != value) ZoomStatePurge();
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(false),
         Description("true to force the Y axis ranges for all GraphPanes to match")] public bool IsSynchronizeYAxes {
            get { return _isSynchronizeYAxes; }
            set {
                if (_isSynchronizeYAxes != value) ZoomStatePurge();
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(false),
         Description("true to scroll the Y2 axis along with the Y axis")] public bool IsScrollY2 {
            get {
                if (_y2ScrollRangeList != null && _y2ScrollRangeList.Count > 0) return _y2ScrollRangeList[0].IsScrollable;
                return false;
            }
            set {
                if (_y2ScrollRangeList == null || _y2ScrollRangeList.Count <= 0) return;
                var tmp = _y2ScrollRangeList[0];
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         Description("Sets the manual scroll bar ranges for the collection of Y axes")] 		 public ScrollRangeList
            YScrollRangeList {
        ...
        /// <seealso cref="ScrollMaxY2" />
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         Description("Sets the manual scroll bar ranges for the collection of Y2 axes")] 		 public ScrollRangeList
            Y2ScrollRangeList {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(0),
         Description("Sets the manual scroll minimum value for the X axis")] public double ScrollMinX {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(0),
         Description("Sets the manual scroll maximum value for the X axis")] public double ScrollMaxX {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(0),
         Description("Sets the manual scroll minimum value for the Y axis")] public double ScrollMinY {
            get {
                if (_yScrollRangeList != null && _yScrollRangeList.Count > 0) return _yScrollRangeList[0].Min;
                return double.NaN;
            }
            set {
                if (_yScrollRangeList == null || _yScrollRangeList.Count <= 0) return;
                var tmp = _yScrollRangeList[0];
                tmp.Min = value;
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(0),
         Description("Sets the manual scroll maximum value for the Y axis")] public double ScrollMaxY {
            get {
                if (_yScrollRangeList != null && _yScrollRangeList.Count > 0) return _yScrollRangeList[0].Max;
                return double.NaN;
            }
            set {
                if (_yScrollRangeList == null || _yScrollRangeList.Count <= 0) return;
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(0),
         Description("Sets the manual scroll minimum value for the Y2 axis")] public double ScrollMinY2 {
            get {
                if (_y2ScrollRangeList != null && _y2ScrollRangeList.Count > 0) return _y2ScrollRangeList[0].Min;
                return double.NaN;
            }
            set {
                if (_y2ScrollRangeList == null || _y2ScrollRangeList.Count <= 0) return;
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(0),
         Description("Sets the manual scroll maximum value for the Y2 axis")] public double ScrollMaxY2 {
            get {
                if (_y2ScrollRangeList != null && _y2ScrollRangeList.Count > 0) return _y2ScrollRangeList[0].Max;
                return double.NaN;
            }
            set {
                if (_y2ScrollRangeList == null || _y2ScrollRangeList.Count <= 0) return;
        ...
        public Boolean IsScrolling {
            get {
                if (hScrollBar1 != null && vScrollBar1 != null) return hScrollBar1.Capture || vScrollBar1.Capture;                 
                return false;
            }
        }
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Sets the numeric display format string for the point value tooltips")] public string
            PointValueFormat {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         ...
         Description("Sets the date display format for the point value tooltips")] public string PointDateFormat {
        ...
        [Bindable(true), Category("Display"), NotifyParentProperty(true),
         DefaultValue(0.1),
         Description("Sets the step size fraction for zooming with the mouse wheel")] public double ZoomStepFraction {
        ...
        /// </summary>
        [Bindable(true), Category("Display"), NotifyParentProperty(true), DefaultValue(false),
         Description("true to center the mouse wheel zoom at the current mouse location")] public bool
            IsZoomOnMouseCenter { get; set; }
        ...
        /// </summary>
        [Bindable(false), Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public bool BeenDisposed {
        ...
        /// </summary>
        [Bindable(true), Category("Display"), NotifyParentProperty(true), DefaultValue(false),
         Description("true to allow selecting Curves")] public bool IsEnableSelection { get; set; }
        ...
        /// </exception>
        [Bindable(false), Browsable(false),
         DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)] public Image GetImage() {
            lock (this) {
                if (BeenDisposed || _masterPane == null || _masterPane[0] == null) throw new ZedGraphException("The control has been disposed");
