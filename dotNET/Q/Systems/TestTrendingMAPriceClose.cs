...
namespace Q.Systems {
    [TestFixture]
    public class TestTrendingMAPriceClose : AbstractTrendingCloseTest<TrendingMAPriceClose> {
        Bar lastBar;
        ...
        public void testEnterShortExit() {
            ...
            requireShortStop(8.61290322580645);
            close(8, 8, 8, 8);
            requireShortExit(8.0, 8.61290322580645, 62);
            fill(1,8.0);
            noOrders();
