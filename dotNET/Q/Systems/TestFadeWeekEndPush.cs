...
namespace Q.Systems {
    [TestFixture]
    public class TestFadeWeekEndPush : OneSymbolSystemTest<FadeWeekEndPush> {
        Bar lastBar;
        ...
        public void testShortFade() {
            ...
            fill(0, 120);
            hasOrders(symbol().buy("TrailingStop", stop(126.849315068493), 146, oneBar()));
            processClose(118,118,118,118, date("2008-02-04"));
            hasOrders(symbol().buy("TrailingStop", stop(126.849315068493), 146, oneBar()));
            processBar(118,118,118,118, date("2008-02-04"));
            hasOrders(symbol().buy("TrailingStop", stop(124.849315068493), 146, oneBar()));
            processClose(119,119,119,119, date("2008-02-05"));
            hasOrders(symbol().buy("TrailingStop", stop(124.849315068493), 146, oneBar()),
                      symbol().buy("ExitDayReached", market(), 146, oneBar()));
            fill(1, 119);
            noOrders();
        }
        ...
        public void testLongFade() {
            ...
            fill(0, 81);
            hasOrders(symbol().sell("TrailingStop", stop(76.5156950672646), 223, oneBar()));
            ...
            hasOrders(symbol().sell("TrailingStop", stop(76.5156950672646), 223, oneBar()),
                      symbol().sell("ExitDayReached", market(), 223, oneBar()));
            fill(1, 79);
            noOrders();
        }
        ...
        public void testStoppedOut() {
            ...
            fill(0, 120);
            hasOrders(symbol().buy("TrailingStop", stop(126.849315068493), 146, oneBar()));
            processClose(127,127,127,127, date("2008-02-04"));
            hasOrders(symbol().buy("TrailingStop", stop(126.849315068493), 146, oneBar()));
            fill(0, 127);
            noOrders();    
        }
    ...
    [TestFixture]
    public class TestFadeWeekEndPushStopMultiple2 : OneSymbolSystemTest<FadeWeekEndPush> {
        Bar lastBar;
        ...
        public void testShortFade() {
            ...
            fill(0, 120);
            hasOrders(symbol().buy("TrailingStop", stop(133.698630136986), 73, oneBar()));
            processClose(118,118,118,118, date("2008-02-04"));
            hasOrders(symbol().buy("TrailingStop", stop(133.698630136986), 73, oneBar()));
            processBar(118,118,118,118, date("2008-02-04"));
            hasOrders(symbol().buy("TrailingStop", stop(131.698630136986), 73, oneBar()));
            processClose(119,119,119,119, date("2008-02-05"));
            hasOrders(symbol().buy("TrailingStop", stop(131.698630136986), 73, oneBar()),
                      symbol().buy("ExitDayReached", market(), 73, oneBar()));
            fill(1, 119);
            noOrders();
        }
        ...
        public void testLongFade() {
            ...
            fill(0, 81);
            hasOrders(symbol().sell("TrailingStop", stop(71.990990990991), 111, oneBar()));
            processClose(80,80,80,80, date("2008-02-04"));
            hasOrders(symbol().sell("TrailingStop", stop(71.990990990991), 111, oneBar()));
            processBar(80, 80, 80, 80, date("2008-02-04"));
            hasOrders(symbol().sell("TrailingStop", stop(71.990990990991), 111, oneBar()));
            processClose(79, 79, 79,79, date("2008-02-05"));
            hasOrders(symbol().sell("TrailingStop", stop(71.990990990991), 111, oneBar()),
                      symbol().sell("ExitDayReached", market(), 111, oneBar()));
            fill(1, 79);
            noOrders();
        }
        ...
        public void testStoppedOut() {
            ...
            fill(0, 120);
            hasOrders(symbol().buy("TrailingStop", stop(133.698630136986), 73, oneBar()));
            processClose(134,134,134,134, date("2008-02-04"));
            hasOrders(symbol().buy("TrailingStop", stop(133.698630136986), 73, oneBar()));
            fill(0, 134);
            noOrders();    
        }
