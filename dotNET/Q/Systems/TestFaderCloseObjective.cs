...
namespace Q.Systems {
        [TestFixture] public class TestFaderCloseMaxBarsHeld : TestFaderCloseObjectiveBase {
        [Test] public void MaxBarsHeldStopOut() {
            close(40);
            noOrders();
            close(54);
            ...
            close(54);
            close(54);
            hasOrders(  position().exitShort("MaxBarsX", limit(54 + 2*0.015625), oneBar()),
                        position().exitShort("SX Objective", limit(54), oneBar()));
        }
    ...
    [TestFixture] public class TestFaderCloseObjectiveMinTradeSize : TestFaderCloseObjectiveBase {
    ...
    public class TestFaderCloseObjectiveConfirm : TestFaderCloseObjectiveBase {
    ...
    public abstract class TestFaderCloseObjectiveBase : OneSymbolSystemTest<FaderCloseObjective> {
    ...
    [TestFixture] public class TestFaderCloseObjective : TestFaderCloseObjectiveBase {
        ...
        [Test] public void zScoreEnterAndExit() {
            ...
            noOrders();
            close(55);
            hasOrders(  sell("PriceObjectiveLX",limit(46.07350525498260),2263,oneBar()),
                        position().exitLong("LX Objective", limit(55), oneBar()));
        }
        ...
        [Test] public void enterAndExitSameBar() {
            ...
            close(55);
            hasOrders(  sell("PriceObjectiveLX",limit(37.7743569596841),10784,oneBar()),
                        position().exitLong("LX Objective", limit(55), oneBar()));
            fill(0, 55);
