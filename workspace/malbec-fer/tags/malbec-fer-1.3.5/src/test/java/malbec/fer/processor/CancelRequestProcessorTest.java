...
public class CancelRequestProcessorTest extends AbstractProcessorTest {
    ...
    public void testNewOrderDMACancelRequestDMA() {
        DatabaseMapper dbm = createDatabaseMapper();
        AbstractOrderRequestProcessor crp = new CancelRequestProcessor(dbm);
    ...
    @Test(groups = { "unittest" })
    public void testNewOrderTicketCancelRequestTicket() {
        DatabaseMapper dbm = createDatabaseMapper();
        AbstractOrderRequestProcessor crp = new CancelRequestProcessor(dbm);
        AbstractOrderRequestProcessor op = new OrderProcessor(dbm);
    ...
    @Test(groups = { "unittest" })
    public void testNewOrderStageCancelRequestStage() {
        DatabaseMapper dbm = createDatabaseMapper();
        AbstractOrderRequestProcessor crp = new CancelRequestProcessor(dbm, new FerretRouter(null, dbm));
        AbstractOrderRequestProcessor op = new OrderProcessor(dbm);
    ...
    @Test(groups = { "unittest" })
    public void testNewOrderStageCancelRequestTicket() {
        DatabaseMapper dbm = createDatabaseMapper();
        AbstractOrderRequestProcessor crp = new CancelRequestProcessor(dbm, new FerretRouter(null, dbm));
        AbstractOrderRequestProcessor op = new OrderProcessor(dbm);
