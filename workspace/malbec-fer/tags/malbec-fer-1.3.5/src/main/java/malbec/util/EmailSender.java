...
public class EmailSender {
    ...
    public EmailSender(EmailSettings es) {
        this(es.getAsProperties());
    }
    
    public boolean sendMessage(String subject, String messageBody, EmailSettings emailSettings) {
        return sendMessage(subject, messageBody, emailSettings.getAsProperties());
    }

    public boolean sendMessage(String subject, String messageBody) {
        return sendMessage(subject, messageBody, props);
    }

    public boolean sendMessage(String subject, String messageBody, Properties props) {
        ...
        try {
            ...
            // Either we have an issue with the mail server, or
            // we are running the tests without access to the server
