...
public class MessageUtil {
    ...
    public static DateTime getPublishTimestamp(Map<String, String> record) {
        ...
        DateTime dt = DateTimeUtil.parseTimestampTimeZone(timestamp);
    ...
    public static void setPublishTimestamp(long timestamp, Map<String, String> record) {
        ...
        timestampStr = DateTimeUtil.formatTimestampTimeZone(new DateTime(timestamp));
