...
public class FuturesSymbolMapper {
    ...
    public void addBloombergToRicMapping(String platform, String bloombergRoot, String ricRoot) {
        FuturesSymbolMap fs = new FuturesSymbolMap(platform, bloombergRoot, ricRoot);
        // add to the platform -> other mapping
