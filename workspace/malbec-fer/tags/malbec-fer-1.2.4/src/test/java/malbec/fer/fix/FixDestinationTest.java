...
public class FixDestinationTest extends AbstractFixTest {
    ...
    public void testTradeStationFuturesCreate() throws Exception {
        ...
        Order testOrder = ot.createFuturesOrder();
        ...
        assertEquals("USM09", fixMessage.getString(SecurityID.FIELD), "Incorrect value for symbol/SecurityID");
...
/*        testOrder.setSymbol("ADZ9");
        to = (FixTransportableOrder) fd.createOrder(testOrder);
        ...
        assertEquals("6AZ09", fixMessage.getString(SecurityID.FIELD), "Incorrect value for symbol/SecurityID");
        assertEquals("100", fixMessage.getString(SecurityIDSource.FIELD), "Incorrect value for ID source");
        assertFalse(fixMessage.isSetField(Symbol.FIELD), "Symbol is set");
*/
        fc.stop();
