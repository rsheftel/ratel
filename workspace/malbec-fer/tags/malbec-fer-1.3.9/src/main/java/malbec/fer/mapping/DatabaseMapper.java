...
public class DatabaseMapper implements IDatabaseMapper {
    ...
    public String lookupAccountForRoute(String platform, String route, String accountType) {
        return ram.lookupAccount(platform, route, accountType);
    }
    ...
    public void addRouteAccount(String platform, String route, String account, String accountType) {
        ram.addMapping(platform, route, account, accountType);
    }
