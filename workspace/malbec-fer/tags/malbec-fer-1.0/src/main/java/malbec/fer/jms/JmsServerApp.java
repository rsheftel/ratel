...
public class JmsServerApp extends AbstractJmsApp {
    ...
    public void setConfiguration(Properties props) {
        ...
        jmsSession.setConsumerQueue(props.getProperty("jms.command.queue"));
        jmsSession.setProducerQueue(props.getProperty("jms.response.queue"));
    }

    public int getUnprocessedMessageCount() {
        ServerApplication jmsApp = (ServerApplication)jmsSession.getJmsApp();
    ...
    public boolean publishResponse(Map<String, String> message, List<String> errors) {
        try {
            jmsSession.publishResponse(message, errors);
