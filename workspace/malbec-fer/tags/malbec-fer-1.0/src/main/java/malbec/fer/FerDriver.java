...
public class FerDriver {
    ...
    private static FerRouter ferRouter;
    
    private static BeanFactory getBeanFactory ()
    {
        XmlBeanFactory factory = new XmlBeanFactory(new ClassPathResource("fercontext.xml"));
    ...
    public static void main(String[] args) {
        ...
        // Start the router
        ferRouter = (FerRouter) factory.getBean("FerRouter");
        runLoop();
    }
