 ...
 * 
 */
public class JmsServerSessionApp extends AbstractJmsApp implements MessageListener,
    IMessageProcessListener {
    ...
    public JmsServerSessionApp(String sessionName, EmailSettings emailSettings, Properties config) throws InvalidConfigurationException {
    ...
    public void onMessage(Message message) {
        ...
        if (message instanceof TextMessage) {
            ...
            try {
                ...
                DateTime orderDateTime = DateTimeUtil.guessDateTime(MessageUtil.getOrderDate(orderRecord));
                ...
                if (replyTo != null) {
                    ...
                    log.warn("Received message with no 'ReplyTo', no response will be sent." + orderRecord);
                }
...
//                }
    ...
    public int broadcastStatus(String userOrderId, LocalDate orderDate, Map<String, String> message, List<String> errors) {
        ...
        int errorCount = 0;
        Map<String, String> messageWithErrors = new HashMap<String, String>((message.size() + errors.size()) * 4);
        ...
        try {
            TextMessage textMessage = jmsSession.createTextMessage(MessageUtil.createRecord(messageWithErrors));
...
//            topicStatusBroadcast(topicPrefix, userOrderId, textMessage);
            ...
            textMessage.setStringProperty("JmsOriginalMessageID", MessageUtil.getOriginalMessageID(messageWithErrors));
            ...
            for (Destination destination : destinations) {
                try {
                    ...
                    log.error("Unable to publish status for "+ userOrderId + " to " + destination.toString(),e);
                } 
            }
    ...
    private void topicStatusBroadcast(String topicBase, String topicPrefix, String clientOrderId, TextMessage textMessage) throws JMSException {
    ...
    @Override
    public int broadcastStatus(String userOrderId, LocalDate orderDate, Map<String, String> message, String errorMessage) {
