...
public class FerRouter implements PropertyChangeListener, IMessageProcessor {
    ...
    public FerRouter(EmailSettings emailSettings, IDatabaseMapper dbm) {
...
//            log.warn("Add logic to handle this: " + text);
    ...
    private FixFill findBustedFill(FixFill fill) {
        ...
        return dao.findById(fill.getBeginString(), fill.getSenderCompId(), fill.getSenderSubId(), fill.getTradeDate(), fill.getExecutionReferenceId());
    }
