...
public class RediFixTestClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final FixClient fc = new FixClient("RediDropCopySession", ta, createInitiatorSession());
    ...
    public static Properties createInitiatorSession() throws IOException {
        ...
        props.load(RediFixTestClient.class.getClassLoader().getResourceAsStream("reditestclient.properties"));
