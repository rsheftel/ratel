...
public class RediPlusDestinationTest extends AbstractBaseTest {
    ...
    public void testSendOrderEquity() {
        ...
        // do a limit buy
        Order order = new Order("IT-" + System.nanoTime(), "ZVZZT", "EQUITY", BBYellowKey.Equity, "BUY", "LIMIT", quantity,
                "UnitTestRedi");
        ...
        // limit sell
        order = new Order("IT-" + System.nanoTime(), "ZVZZT", "EQUITY", BBYellowKey.Equity, "Sell", "LIMIT", quantity,
                "UnitTestRedi");
        ...
        // limit short sell
        order = new Order("IT-" + System.nanoTime(), "ZVZZT", "EQUITY", BBYellowKey.Equity, "Sellshort", "LIMIT", quantity,
                "UnitTestRedi");
    ...
    public void testSendOrderEquityBasket() {
        ...
        // do a limit buy
        Order order = new Order("IT-" + System.nanoTime(), "ZVZZT", "EQUITY", BBYellowKey.Equity, "SELL", "LIMIT", quantity,
                "UnitTestRedi");
        ...
        // limit sell
        order = new Order("IT-" + System.nanoTime(), "ZVZZT", "EQUITY", BBYellowKey.Equity, "BUY", "LIMIT", new BigDecimal(200),
                "UnitTestRedi");
        ...
        // limit short sell
        order = new Order("IT-" + System.nanoTime(), "ZXZZT", "EQUITY", BBYellowKey.Equity, "SELLSHORT", "LIMIT", BigDecimal.ONE,
                "UnitTestRedi");
    ...
    public void testSendOrderFutures() {
        ...
        // do a limit buy
        Order order = new Order("IT-" + System.nanoTime(), "EDZ8", "FUTURES", BBYellowKey.Curncy, "BUY", "LIMIT", quantity,
                "UnitTestRedi");
