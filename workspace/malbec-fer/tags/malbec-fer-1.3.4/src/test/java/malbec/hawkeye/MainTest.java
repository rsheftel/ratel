...
import static malbec.jms.DestinationHandlerTest.publishFerretStateMessage;
...
//        Main main = new Main();
//        
//        List<LiveOrder> tomahawkOrders = new ArrayList<LiveOrder>();
//        List<Order> ferretOrders = new ArrayList<Order>();
//        
//        tomahawkOrders.add(new LiveOrder(new Row()));
//        
//        main.compareAndReportMismatches(tomahawkOrders, ferretOrders);
//    }
