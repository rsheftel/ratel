...
public class FerretRouterRediTest extends AbstractBaseTest {
    ...
    public void receiveJmsSendViaRedi() throws Exception {
        ...
        FerretRouter fr = new FerretRouter(new EmailSettings(), sam);
        ...
        Order limitOrder = OrderTest.createLimitOrder("RediServer");
