...
public class MarketTickersMapper {
     ...
     * @param platformRoot
     */
    public void addMarketMapping(String market, String bloomberg, String yellowKey, String tsdb) {
        MarketTicker mt = new MarketTicker(market, bloomberg, yellowKey, tsdb);
    ...
    public BBYellowKey lookupYellowKey(String market) {
        MarketTicker mt = marketToBloomberg.get(market.toUpperCase());
