...
public class DatabaseMapper implements IDatabaseMapper {
    ...
    public void addFuturesMultiplier(String platform, String bloombergRoot, String ricRoot,
        BigDecimal multiplier) {
        fsm.addBloombergToRicMapping(platform, bloombergRoot, ricRoot, multiplier);
    }
    ...
    public void addMarketMapping(String marketSymbol, String bloombergSymbol, String yellowKey, String tsdbSymbol) {
        mtm.addMarketMapping(marketSymbol, bloombergSymbol, yellowKey, tsdbSymbol);
    }
    ...
    @Override
    public BBYellowKey lookupYellowKey(String symbolRoot) {
        return mtm.lookupYellowKey(symbolRoot+".1C");
    }
}
