...
public class FuturesSymbolMapperTest {
    ...
    public void testMapping() {
        ...
        fsm.addBloombergToRicMapping(PLATFORM, BLOOMBERG_ROOT, RIC_ROOT, BigDecimal.ONE);
        ...
        assertEquals(fsm.lookupFuturesOutboundPriceMultiplier(PLATFORM, BLOOMBERG_ROOT), BigDecimal.ONE);
    }
}
