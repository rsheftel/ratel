...
public abstract class AbstractFixTest extends AbstractBaseTest {
    ...
    @BeforeMethod(groups = { "usefix", "unittest", "unittest-fix" })
    public void startQuickFix() throws Exception {
        ...
        System.out.println("Server is started - listening to port:" + qfjSettings.getString(sessionId, Acceptor.SETTING_SOCKET_ACCEPT_PORT));
        PositionCache.getInstance().updatePosition("MFPB", "ZVZZT", 0);
    }

    @AfterMethod(groups = { "usefix", "unittest", "unittest-fix" })
