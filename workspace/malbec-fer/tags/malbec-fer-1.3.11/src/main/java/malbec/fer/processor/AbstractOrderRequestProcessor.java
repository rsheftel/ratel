...
public abstract class AbstractOrderRequestProcessor implements IOrderRequestProcessor {
    ...
    protected Map<String, String> createMinimalResponseMap(Map<String, String> sourceMessage) {
        Map<String, String> returnMessage = new HashMap<String, String>();
        
        MessageUtil.setClientAppName(MessageUtil.getClientAppName(sourceMessage), returnMessage);
        MessageUtil.setClientHostname(MessageUtil.getClientHostname(sourceMessage), returnMessage);
        MessageUtil.setClientUserId(MessageUtil.getClientUserId(sourceMessage), returnMessage);
    ...
    protected static LocalDate extractOrderDate(Map<String, String> sourceMessage) {
