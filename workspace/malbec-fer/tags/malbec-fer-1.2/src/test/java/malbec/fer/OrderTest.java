...
public class OrderTest extends AbstractBaseTest {
    ...
    public void testInsert() {
        ...
        Order order = new Order(userOrderId, "ZVZZT", "EQUITY", "BUY", "LIMIT", new BigDecimal(
                12), "TEST-SERVER");
        ...
        Order futuresOrder = new Order(userOrderId, "USM9", "FUTURES", "BUY", "LIMIT",
    ...
    public void testDuplicatInsert() {
        ...
        Order duplicateOrder = new Order(order.getUserOrderId(), "ZVZZT", "EQUITY", "BUY", "LIMIT", new BigDecimal(
                12), "TEST-SERVER");
    ...
    public Order createLimitOrder(String platform) {
        Order order = createLimitOrder();
