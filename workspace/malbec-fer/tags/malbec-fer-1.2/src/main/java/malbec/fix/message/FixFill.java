...
public class FixFill {
    ...
    @Column(name = "MultipliedLastPrice")
    private BigDecimal multipliedLastPrice; // only for Futures
    ...
    public void setMultipliedLastPrice(BigDecimal multipliedLastPrice) {
        this.multipliedLastPrice = multipliedLastPrice;
    }
    ...
    /**
     * @return the multipliedLastPrice
     */
    public BigDecimal getMultipliedLastPrice() {
        return multipliedLastPrice;
    }
