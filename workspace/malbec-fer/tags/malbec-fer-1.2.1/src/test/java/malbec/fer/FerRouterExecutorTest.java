...
import static malbec.fer.CancelRequestTest.*;
 ...
 */
public class FerRouterExecutorTest extends AbstractBaseTest {

    private static final class TestMessageProcessorListener implements IMessageProcessListener {
        ...
        public String getErrorMessageFor(String clientOrderId) {
            return ordersWithErrors.get(clientOrderId);
        }
    ...
    public void testCreateOrder44() throws Exception {
        ...
        // Limit Order
        Order limitOrder = ot.createLimitOrder(EXECUTOR44);
    ...
    public void testCreateOrder42() throws Exception {
        // Send an order that should make it to the execution engine
        // Limit Order
        Order limitOrder = ot.createLimitOrder(EXECUTOR42);
        System.out.println("Sending limit order: " + limitOrder.getUserOrderId());
    ...
    public void testFillOrder44() throws Exception {
        ...
        Order filledOrder = dao.findOrderByUserOrderId(limitOrder.getUserOrderId(), limitOrder.getOrderDate());
    ...
    public void testCancelOrder44() throws Exception {
        ...
        Order orderToCancel = ot.createLimitOrder(EXECUTOR44);
        ...
        assertNotNull(canceledOrder, "Did not select order by 'ClientOrderID' "
                + cr.getOriginalUserOrderId());
    ...
    public void testCancelOrder42() throws Exception {
        // Create an order to cancel
        Order orderToCancel = ot.createLimitOrder(EXECUTOR42);
        ...
        Order canceledOrder = dao.findOrderByUserOrderId(cr.getOriginalUserOrderId(), cr.getOrderDate());
        assertNotNull(canceledOrder, "Did not select order by 'UserOrderID' "
                + cr.getOriginalUserOrderId());
        assertNotNull(canceledOrder.getOrderID(), "Limit Order not accepted by engine");
        assertEquals(canceledOrder.getStatus(), OrderStatus.Cancelled, "Order not cancelled by engine");
    }
