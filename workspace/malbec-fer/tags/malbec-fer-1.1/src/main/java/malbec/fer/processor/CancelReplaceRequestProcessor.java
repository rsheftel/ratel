...
public class CancelReplaceRequestProcessor extends OrderProcessor {
    ...
    public CancelReplaceRequestProcessor(DatabaseMapper dbm) {
        super(dbm);
    ...
    public Map<String, String> process(Map<String, String> sourceMessage, Map<String, IOrderDestination> orderDestinations) {
        ...
        synchronized (getLock(cancelReplaceRequest.getOriginalUserOrderId())) {
            Order orderToCancel = dao.findOrderByUserOrderId(cancelReplaceRequest.getOriginalUserOrderId(), cancelReplaceRequest.getOrderDate());
            if (orderToCancel == null) {
                ...
                addErrorToMessage(returnMessage, "Order of status " + orderStatus 
                        + " cannot be replaced "
                        + cancelReplaceRequest.getOriginalUserOrderId());
                MessageUtil.setStatus(returnMessage, Rejected.toString());
