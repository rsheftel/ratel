 ...
 */
public class SpreadTradeProcessor extends BaseOrderRequestProcessor {
    private final Logger log = LoggerFactory.getLogger(getClass());

    public SpreadTradeProcessor(DatabaseMapper dbm) {
        super(dbm);
    }
...
//            orderToSend = destination.createTransportableOrder(spreadTrade, orderRequestType);
        ...
        if (destination == null || platform == null || badKey || errors.size() > 0 || !canTradeOnPlatform
            ...
            if (platform == null) {
                ...
                errors.add("No destination mapping for platform.  Valid choices are: " + buildPlatformList(orderDestinations));
