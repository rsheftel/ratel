...
public class CancelRequestProcessor extends OrderProcessor {
    ...
    public CancelRequestProcessor(DatabaseMapper dbm) {
        super(dbm);
    ...
    public Map<String, String> process(Map<String, String> sourceMessage, Map<String, IOrderDestination> orderDestinations) {
        ...
        synchronized (getLock(cancelRequest.getOriginalUserOrderId())) {
            Order orderToCancel = dao.findOrderByUserOrderId(cancelRequest.getOriginalUserOrderId(), cancelRequest.getOrderDate());
