...
class RouteAccountMapper {
    ...
    private synchronized int initialize(Map<PlatformRoute, PlatformRouteAccount> map) {
        ...
        for (PlatformRouteAccount pra : results) {
            ...
            if (pra.platform != null && pra.route != null && pra.account != null) {
                map.put(new PlatformRoute(pra.platform, pra.route, pra.accountType), pra);
            }
        }
    ...
    private static class PlatformRoute {
        ...
        public PlatformRoute(String platform, String route, String accountType) {
    ...
    public String lookupAccount(String platform, String route, String accountType) {
        PlatformRouteAccount pra = praMap.get(new PlatformRoute(platform, route, accountType));
    ...
    public void addMapping(String platform, String route, String account, String accountType) {

        if (platform != null && route != null && account != null) {
            praMap.put(new PlatformRoute(platform, route, accountType), new PlatformRouteAccount(platform,
                route, account, accountType));
        }
