...
public class FixClientStateListener implements SessionStateListener, PropertyChangeListener {
    ...
    public void onDisconnect() {
        ...
        // This may send out emails when we have requested to stop the session.  I think
        // that is because of the threads handling the session and the session may have
        // cleared its logoutSent flag.
