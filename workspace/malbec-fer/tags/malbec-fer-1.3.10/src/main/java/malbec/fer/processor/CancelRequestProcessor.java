...
public class CancelRequestProcessor extends OrderProcessor {
    ...
    public Map<String, String> process(Map<String, String> sourceMessage,
        ...
        Map<String, String> returnMessage = createStandardResponseMap(cancelRequest);
        ...
        String originalUserOrderId = cancelRequest.getOriginalUserOrderId();
        if (originalUserOrderId == null) {
            log.warn("Received cancel request without originalUserOrderId");
            returnMessage.put("ERROR_0", "Received cancel request without originalUserOrderId");
            
            return returnMessage;
        }
        synchronized (getLock(originalUserOrderId)) {
