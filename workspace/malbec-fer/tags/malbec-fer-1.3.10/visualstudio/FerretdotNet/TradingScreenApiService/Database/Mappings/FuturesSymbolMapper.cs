...
namespace TradingScreenApiService.Database.Mappings
{
    ...
    public class FuturesSymbolMapper
    {
        ...
        */
        public int Initialize(ISession session)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public int Reload(ISession session)
        {
        ...
        private static IList<FuturesSymbolMapping> LoadAll(ISession session)
        {
            var products = session.CreateCriteria(typeof (FuturesSymbolMapping)).List<FuturesSymbolMapping>();
            return products;
        }
        /*
