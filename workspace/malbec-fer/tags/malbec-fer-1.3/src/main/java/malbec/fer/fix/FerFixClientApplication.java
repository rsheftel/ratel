...
public class FerFixClientApplication extends FixClientApplication implements IPropertyChangeSupport {
    ...
    @Override
    public void onMessage(quickfix.fix44.BusinessMessageReject fixMessage, SessionID sessionID) throws FieldNotFound,
            UnsupportedMessageType, IncorrectTagValue {
        onBusinessRejectMessage(fixMessage, sessionID);
    }
    
    @Override
    public void onMessage(quickfix.fix42.BusinessMessageReject fixMessage, SessionID sessionID) throws FieldNotFound,
            UnsupportedMessageType, IncorrectTagValue {
        onBusinessRejectMessage(fixMessage, sessionID);
    }
...
//                        RefMsgType refMsgType = new RefMsgType(fixMessage.getString(RefMsgType.FIELD));
                        ...
                        ffe = new FerRejectEvent(this, BusinessMessageReject, fixMessage, referencedMessage, rejectReasonCode);
                        ffe.setErrorMessage(getRejectReason(fixMessage));
    ...
    @Override
    public void onMessage(quickfix.fix42.OrderCancelReject message, SessionID sessionID) throws FieldNotFound,
        UnsupportedMessageType, IncorrectTagValue {
        onOrderCancelRejectMessage(message, sessionID);
    }
    ...
    @Override
    public void onMessage(quickfix.fix44.Reject fixMessage, SessionID sessionId) throws FieldNotFound, UnsupportedMessageType,
        IncorrectTagValue {
        onRejectMessage(fixMessage, sessionId, FixVersion.F44);
    }

    @Override
    public void onMessage(quickfix.fix42.Reject fixMessage, SessionID sessionId) throws FieldNotFound, UnsupportedMessageType,
        IncorrectTagValue {
     ...
     * 
     * Rejects are sent on failed logins with invalid sequence numbers, need to determine 
     * if that is the reject reason.
     * 
     * @param fixMessage
     * @param sessionId
     ...
     */
    protected void onRejectMessage(Message fixMessage, SessionID sessionId, FixVersion version) throws FieldNotFound, UnsupportedMessageType,
            IncorrectTagValue {
