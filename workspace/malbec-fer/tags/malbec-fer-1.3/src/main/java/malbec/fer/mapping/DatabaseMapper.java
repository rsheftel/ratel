...
//        ps.reload();
    ...
    public void addFuturesMultiplier(String platform, String bloombergRoot, String ricRoot, BigDecimal multiplier) {
    ...
    public void addMarketMapping(String marketSymbol, String bloombergSymbol, String tsdbSymbol) {
        mtm.addMarketMapping(marketSymbol, bloombergSymbol, tsdbSymbol);
    }
}
