...
public class RediPlusOrder extends AbstractBaseCom {
    ...
    public String getExchangeString() throws ComException {
    ...
    public void setExchange(String newExchange) throws ComException {
        put("Exchange", newExchange);
    }
     ...
     * @return void
     */
    public void setTFList(String vTFList) throws ComException {
//        putByRef("SetTFList", vTFList);
//        put("SetTFList", vTFList );
        Dispatch sc = getDispatch();
        
        Dispatch.call(sc, "SetTFList", new Variant(vTFList));
    }
     ...
     * @return void
     */
    public void setTFUser(String vTFUser) throws ComException {
        Dispatch sc = getDispatch();
        
        Dispatch.call(sc, "SetTFUser", new Variant(vTFUser));
    }
