...
public interface FixClientMBean {
    ...
    /**
     * Request a resend of messages from the <code>startSequenceNumber</code> to current.
     * 
     * @param startSequenceNumber
     */
    void requestResend(int startSequenceNumber);
    
    void requestResend(int startSequenceNumber, int endSequenceNumber);
