...
public class StagedOrderProcessor extends OrderProcessor {
    ...
    public Map<String, String> process(Map<String, String> sourceMessage,
        ...
        if (Ticket == ferretState || DMA == ferretState) {
            ...
            synchronized (getLock(userOrderId)) {
                ...
                // we made changes while creating, ensure we update
                dao.updateOrder(orderToRelease);
    ...
    /* (non-Javadoc)
     * @see malbec.fer.processor.AbstractOrderRequestProcessor#convertMarketSymbol(malbec.fer.Order, java.util.List)
     */
    @Override
