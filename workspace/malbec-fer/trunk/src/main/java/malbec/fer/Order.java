...
import static malbec.fer.util.OrderValidation.generateClientOrderId;
import static malbec.fer.util.OrderValidation.isValidUserOrderId;
...
public class Order {
    ...
    private String side;
    private String buyToCover; // Tag 6089 - Y/N or empty
...
//    private String status;
    ...
    public Order() {
        transactionTime = new DateTime().toDate();
...
//        status = "NEW";
    ...
    public Order(String userOrderID, String symbol, String securityType, BBYellowKey yellowKey, String side, String orderType,
    ...
    public Order(Map<String, String> fields) {
        ...
        for (Map.Entry<String, String> entry : fields.entrySet()) {
            ...
            } else if ("BuyToCover".equalsIgnoreCase(key)) {
                buyToCover = upperCaseOrNull(entry.getValue());
...
/*            else if ("FIXMESSAGETYPE".equalsIgnoreCase(key)) {
            ...
            } else if ("YELLOWKEY".equalsIgnoreCase(key)) {
                yellowKey = BBYellowKey.valueFor(entry.getValue());
            }
        }
    ...
    public boolean reallyIsOrder() {
        return getClass().getName().equals("malbec.fer.Order");
    }
    ...
    public Map<String, String> toMap() {
        ...
        if (buyToCover != null) {
            fieldMap.put("BUYTOCOVER", buyToCover);
        }
...
//        }
        ...
        if (yellowKey != null) {
            fieldMap.put("YELLOWKEY", yellowKey.toString());
        }
...
//                }
    ...
    public String toString() {
        ...
        sb.append(", BuyToCover=").append(buyToCover != null ? buyToCover : "");
    ...
    public boolean isFutures() {
        return "futures".equalsIgnoreCase(securityType);
    }
    
    @Transient
    public boolean isEquity() {
        return "equity".equalsIgnoreCase(securityType);
    }
