...
public class CmfAimTradeRecord implements CmfTradeRecord
{
    ...
    private BigDecimal priceQuote = BigDecimal.ZERO; // Type depends on priceQuoteDisplay
...
//        sb.replace(130, 140, formatString(account, 10));
    ...
    public static CmfTradeRecord createFromString (String tradeRecordStr)
    {
        ...
        tradeRecord.setTradingPlatform(TradingPlatform.valueForLongText(tradeRecordStr.substring(323, 368).trim()));
