...
public class CmfAimTradeRecord implements CmfTradeRecord
{
    ...
    private BBSecurityIDFlag securityIdFlag; // Security type
    ...
    private BBYellowKey productCode = BBYellowKey.Unknown;
    ...
    public String getProtocolMessageRegular ()
    {
        ...
        sb.replace(17, 19, formatNumber(securityIdFlag.getIDFlag(), 2));
    ...
    public String getProtocolMessageAim ()
    {
        ...
        if (productCode == null)
        {
            productCode = BBYellowKey.Unknown;
        }

        sb.replace(425, 427, formatNumber(productCode.getCode(), 2));
    ...
    public static CmfTradeRecord createFromString (String tradeRecordStr)
    {
        ...
        tradeRecord.setSecurityIdFlag(BBSecurityIDFlag.valueOf(Integer.parseInt(tradeRecordStr
            .substring(17, 19))));
        // this is where the AIM format is different from the standard record
        ...
        String productCodeStr = tradeRecordStr.substring(425, 427).trim();
        if (productCodeStr.length() == 0)
        {
            productCodeStr = "0"; // default to unknown
        }
        tradeRecord.setProductCode(BBYellowKey.valueOf(Integer.parseInt(productCodeStr)));

        tradeRecord.setExpandedStatus(Integer.parseInt(tradeRecordStr.substring(612, 614)));

        // This field is ignored by BB - here as a test
    ...
    public BBYellowKey getProductCode ()
    {
        return productCode;
    }

    public void setProductCode (BBYellowKey productCode)
    {
