...
/**
 * This has been replaced by individual FIX clients.
 */
@Deprecated 
public class AggregatorApplication extends MessageCracker implements Application
{
    ...
    /**
     * Receive Execution Reports from FIX Feed.
     * 
    ...
    /**
     * This is called by the threaded implementation useThreadedProcessing=true.
     * 
     * This is not used or needed, the issue was identified as a network problem 
     * with Goldman Sachs.
     * 
    ...
    public CmfTradeRecordDAO getDao() {
        return dao;
    }
    ...
    /**
     * This has been copied to the new FixClient logic - if you make changes
     * here, make sure they are applied there as well.
     * 
     * @param fill
     * @return
     */
