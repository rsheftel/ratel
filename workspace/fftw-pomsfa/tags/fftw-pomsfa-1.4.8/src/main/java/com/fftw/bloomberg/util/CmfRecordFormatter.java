...
public class CmfRecordFormatter
{
    ...
    private static final Map<BBSecurityIDFlag, String> securityFlag = new HashMap<BBSecurityIDFlag, String>();
    ...
    {
        securityFlag.put(BBSecurityIDFlag.Cusip, "CUSIP with check digit");
        securityFlag.put(BBSecurityIDFlag.BBUID, "Bloomberg Unique Identifier");
        securityFlag.put(BBSecurityIDFlag.FX, "FX Ticker");
        securityFlag.put(BBSecurityIDFlag.MoneyMarket, "Money Market Ticker");
        securityFlag.put(BBSecurityIDFlag.Equity, "Equity Ticker");
        securityFlag.put(BBSecurityIDFlag.FutureOption, "Future/Option Ticker");
    }
    ...
    public static String formatForEmail (CmfTradeRecord tradeRecord)
    {
        ...
        sb.append("\nside=").append(determineStringSide(tradeRecord.getSide()));
    ...
    private static String determineStringSide(int sideCode) {
        switch (sideCode) {
            case CmfConstants.SIDE_BUY:
                return "buy";
            case CmfConstants.SIDE_BUY_COVER:
                return "cover";
            case CmfConstants.SIDE_SELL:
                return "sell";
            case CmfConstants.SIDE_SELL_SHORT:
                return "short";
            default :
                return "unknown ("+sideCode+")";
        }
    }
    ...
    private static String securityFlagToText (BBSecurityIDFlag securityIdFlag)
    {
