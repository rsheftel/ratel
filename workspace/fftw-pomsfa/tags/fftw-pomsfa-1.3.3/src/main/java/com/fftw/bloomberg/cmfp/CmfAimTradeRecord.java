...
public class CmfAimTradeRecord implements CmfTradeRecord
{
    ...
    public static CmfTradeRecord createFromString (String tradeRecordStr)
    {
        ...
        tradeRecord.setSecurityIdFlag(BBSecurityIDFlag.valueOf(Integer.parseInt(tradeRecordStr.substring(17, 19))));
        // this is where the AIM format is different from the standard record
        ...
        tradeRecord.setProductCode(BBProductCode.valueOf(Integer.parseInt(tradeRecordStr.substring(425, 427))));
