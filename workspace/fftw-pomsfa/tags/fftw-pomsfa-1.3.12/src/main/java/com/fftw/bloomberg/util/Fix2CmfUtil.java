...
public class Fix2CmfUtil
{
    ...
    private static Map<PairKey<TradingPlatform, String>, SymbolMappingEntry> futuresMapping = new HashMap<PairKey<TradingPlatform, String>, SymbolMappingEntry>();
...
//        primeBroker.clear();
    ...
    {
        initializeExchanges();
        futuresMapping = initializeFutures();
     ...
     */
    private static  Map<PairKey<TradingPlatform, String>, SymbolMappingEntry> initializeFutures ()
    {
        ...
        Map<PairKey<TradingPlatform, String>, SymbolMappingEntry> tmpMap = new HashMap<PairKey<TradingPlatform, String>, SymbolMappingEntry>();
