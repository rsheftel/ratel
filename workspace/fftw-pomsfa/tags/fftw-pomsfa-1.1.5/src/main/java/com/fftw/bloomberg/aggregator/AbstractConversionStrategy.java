...
public abstract class AbstractConversionStrategy implements ConversionStrategy
{
        ...
        CmfTradeRecord tradeRecord) throws FieldNotFound
    {
        ...
        if (account == null)
        {
            ...
            errorMessages = addErrorMessage(errorMessages, "No matching account for trade, using " + account);
        }
        ...
        if (tradingStrategy == null)
        {
            ...
            errorMessages = addErrorMessage(errorMessages, "No matching trading strategy for trade, using " + tradingStrategy);
        }
