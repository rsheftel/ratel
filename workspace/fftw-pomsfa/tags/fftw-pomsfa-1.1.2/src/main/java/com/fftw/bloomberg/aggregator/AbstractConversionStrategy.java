...
public abstract class AbstractConversionStrategy implements ConversionStrategy
{
     ...
     */
    public CmfMessage convertMessage (quickfix.fix42.ExecutionReport message) throws FieldNotFound
    {
        ...
        convertCommon(message, tradeRecord);
     ...
     * <ul><li>primeBroker</li></ul>
     * 
     * @param message
     * @param tradeRecord
     * @throws FieldNotFound
     */
    protected void convertCommon (quickfix.fix42.ExecutionReport message, CmfTradeRecord tradeRecord)
        throws FieldNotFound
    {
        ...
        tradeRecord.setAccount(Fix2CmfUtil.bloombergAccount(getPlatform(), message));
        tradeRecord.setTradingStrategy(Fix2CmfUtil.bloombergStrategy(getPlatform(), message));
     ...
     * <ul><li>productCode - equity (2)</li>
     * <li>securityIdFlag - equity ticker (98)</li>
     * <li>settlementDate</li></ul>
     * 
     * Subclasses should call this method first before performing any custom
     * logic.
     * 
     * Fields that are likely to be in subclasses:
     * <ul><li>securityId - symbol</li>
     * <li>broker</li></ul>
     * 
     * @param message
     * @param tradeRecord
     * @throws FieldNotFound
     */
    protected void convertEquities (quickfix.fix42.ExecutionReport message, CmfTradeRecord tradeRecord)
        throws FieldNotFound
    {
     ...
     * 
     * Currently converted fields:
     * <ul><li>productCode - this is not set, logic should be determined to do so</li>
     ...
     * @throws FieldNotFound
     */
    protected void convertOptions (quickfix.fix42.ExecutionReport message, CmfTradeRecord tradeRecord)
        throws FieldNotFound
    {
     ...
     * @throws FieldNotFound
     */
    protected void convertFutures (quickfix.fix42.ExecutionReport message, CmfTradeRecord tradeRecord)
        throws FieldNotFound
    {
        tradeRecord.setSecurityIdFlag(CmfConstants.SIF_FUTURE_OPTION);
    ...
    protected SecurityExchange extractExchange(quickfix.fix42.ExecutionReport message, SecurityExchange defaultExchange) throws FieldNotFound
    {
     ...
     * 
     * The monthYear is important as we are truncating the symbol based on 
     * the year.  Century years 0-9 is minus 2, years 10-99 is minus 3.
     * 
     * 
     * @param symbol
     * @param monthYear
