...
public class CmfAimTradeRecordJdbcDAO implements CmfTradeRecordDAO
{
    ...
    public CmfTradeRecord insert (CmfTradeRecord newTradeRecord) throws SQLException
    {
        ...
        synchronized (CmfAimTradeRecordJdbcDAO.class)
        {
            ...
            int nextNumber = jdbcTemplate.queryForInt(NEXT_SEQ_NO, new Object[]
            {
                jdbcDate
            });
            ...
            parameters[3] = newTradeRecord.getSecurityIdFlag();
            ...
            parameters[18] = newTradeRecord.getProductCode();
        ...
        throws SQLException
    {
        ...
        return jdbcTemplate.queryForObject(FIND_BY_EXEC_ID, new TradeRecordRowMapper(),
            new Object[]
            {
    ...
    private static class TradeRecordRowMapper implements ParameterizedRowMapper<CmfTradeRecord>
    {
        public CmfTradeRecord mapRow (ResultSet rs, int rowNum) throws SQLException
        {
            ...
            tradeRecord.setSecurityIdFlag(rs.getInt("SECURITY_ID_FLAG"));
            ...
            tradeRecord.setProductCode(rs.getInt("PRODUCT_CODE"));
