...
public class CmfAimTradeRecord implements CmfTradeRecord
{
    ...
    private BBProductCode productCode = BBProductCode.Uknown;
    ...
    public String getProtocolMessageAim ()
    {
        ...
        if (productCode == null)
        {
            productCode = BBProductCode.Uknown;
        }

        sb.replace(425, 427, formatNumber(productCode.getID(), 2));
    ...
    public static CmfTradeRecord createFromString (String tradeRecordStr)
    {
        ...
        tradeRecord.setProductCode(BBProductCode.valueOf(Integer.parseInt(productCodeStr)));
