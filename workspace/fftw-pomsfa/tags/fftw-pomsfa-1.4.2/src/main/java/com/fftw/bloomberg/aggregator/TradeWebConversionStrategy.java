...
public class TradeWebConversionStrategy extends AbstractConversionStrategy
{
    ...
    @Override
    protected void convertCds (ExecutionReport message, CmfTradeRecord tradeRecord)
        throws FieldNotFound
    {
    ...
    @Override
    protected void convertGovt (ExecutionReport message, CmfTradeRecord tradeRecord)
        throws FieldNotFound
    {
        tradeRecord.setProductCode(BBProductCode.Government);
