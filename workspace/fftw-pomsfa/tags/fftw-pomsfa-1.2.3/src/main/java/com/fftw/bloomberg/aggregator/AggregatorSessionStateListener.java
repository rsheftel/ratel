    ...
    public void onDisconnect ()
    {
        ...
        Thread timerThread = new Thread(new Runnable()
        {
            public void run ()
            {
                ...
                while (mySession.isSessionTime() && !isConnected() && !isWeekend(new LocalDate()))
                {
                ...
                // We are here because the session has ended/we connected/it is
                // the weekend!
