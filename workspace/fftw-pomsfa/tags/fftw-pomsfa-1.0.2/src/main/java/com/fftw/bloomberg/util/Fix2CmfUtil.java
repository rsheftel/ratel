...
public class Fix2CmfUtil
{
    ...
    {
        synchronized (Fix2CmfUtil.class)
        {
    ...
    public static int mapFuturesProductCode (TradingPlatform platform, Symbol fixSymbol)
    {
    ...
    public static BigDecimal mapFuturesPriceMultiplier (TradingPlatform platform, Symbol fixSymbol)
    {
        PairKey<TradingPlatform, String> key = new PairKey<TradingPlatform, String>(platform,
            fixSymbol.getValue());
     ...
     * @return
     */
    public static String futureSymbol (TradingPlatform platform, Symbol rootSymbol,
     ...
     * @return
     */
    public static String optionsSymbol (Symbol rootSymbol, SecurityExchange exchange,
    ...
    public static String equitySymbol (Symbol symbol, SecurityExchange exchange)
    {
        String bcec = Fix2CmfUtil.fixExchangeToBCC(exchange);
        if (bcec == null)
        {
    ...
    public static String bloombergAccount (TradingPlatform platform, Message message)
    {
        try
        {
    ...
    public static String bloombergStrategy (TradingPlatform platform, Message message)
    {
        try
        {
            for (StrategyAccountEntry entry : strategyAccount)
    ...
    public static String getLoadTimeAsString ()
    {
