...
public abstract class AbstractConversionStrategy implements ConversionStrategy
{
        ...
        CmfTradeRecord tradeRecord) throws FieldNotFound
    {
        ...
        String primeBroker = Fix2CmfUtil.mapPrimeBroker(getPlatform(), AccountType.Unknown, "NO PB");
        tradeRecord.setPrimeBroker(primeBroker);
    }
        ...
        CmfTradeRecord tradeRecord) throws FieldNotFound
    {
        ...
        String primeBroker = Fix2CmfUtil.mapPrimeBroker(getPlatform(), AccountType.Futures, "NO PB");
        tradeRecord.setPrimeBroker(primeBroker);
    }
        ...
        SecurityType securityType) throws FieldNotFound
    {
        ...
        TransactTime tt = new TransactTime(DateTimeUtil.getDate(message.getHeader().getString(SendingTime.FIELD)));
