...
public abstract class AbstractConversionStrategy implements ConversionStrategy
{
        ...
        CmfTradeRecord tradeRecord) throws FieldNotFound
    {
        ...
        if (account == null)
        {
            Map<Integer, String> newMappings = Fix2CmfUtil.determineMissingMappingValues(getPlatform(), message);
            ...
            errorMessages = addErrorMessage(errorMessages, "The following values are missing from the mapping tables to "+ 
