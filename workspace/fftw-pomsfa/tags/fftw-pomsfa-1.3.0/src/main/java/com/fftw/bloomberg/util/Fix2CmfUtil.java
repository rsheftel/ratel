...
//    private static final String INSERT_USER_MAPPED_STRATEGY = "insert into USER_MAPPED_STRATEGY"
//        + " (PLATFORM_ID, FixTAG, TagValue, BloombergStrategy) " + "values ( ?, ?, ?, ? ) ";
    ...
    private static void initializeStrategyAccounts ()
    {
        ...
        List mappings = jdbcTemplate.query(sb.toString(), new StrategyAccountRowMapper());
