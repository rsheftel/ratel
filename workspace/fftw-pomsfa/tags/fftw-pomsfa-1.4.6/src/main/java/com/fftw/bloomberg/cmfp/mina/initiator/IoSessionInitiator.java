...
public class IoSessionInitiator
{
    ...
    private static class ConnectTask implements Runnable
    {
        ...
        public ConnectTask (SocketAddress[] socketAddresses,
            IoFilterChainBuilder userIoFilterChainBuilder, CmfSession cmfSession,
            ...
            GeneralSecurityException
        {
            ...
            DemuxingProtocolCodecFactory codec = cmfSession.getProtocolCodecFactory();
            ...
            ioHandler = new CmfProtocolHandler(cmfSession, networkingOptions);
        }
