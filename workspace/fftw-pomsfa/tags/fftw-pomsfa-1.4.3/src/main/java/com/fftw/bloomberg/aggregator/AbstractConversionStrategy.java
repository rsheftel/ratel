...
public abstract class AbstractConversionStrategy implements ConversionStrategy
{
    ...
    private static final SenderCompID EMSX = new SenderCompID("BLPDROP");
    ...
    protected void convertCds (ExecutionReport message, CmfTradeRecord tradeRecord) throws FieldNotFound
    {
        throw new UnsupportedOperationException("No default behavior for VDS");
    ...
    protected void convertGovt (quickfix.fix42.ExecutionReport message, CmfTradeRecord tradeRecord)
        throws FieldNotFound
    {
        throw new UnsupportedOperationException("No default behavior for TBA");
    }
    ...
    protected int determineSide (quickfix.fix42.ExecutionReport message) throws FieldNotFound
    {
