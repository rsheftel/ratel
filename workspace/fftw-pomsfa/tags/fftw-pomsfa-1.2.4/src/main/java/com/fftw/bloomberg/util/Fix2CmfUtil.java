...
public class Fix2CmfUtil
{
    ...
    private static class RefreshTimer extends TimerTask
    {
        ...
        public void run ()
        {
            ...
            // We have the timer, lets see if we can lower the memory usage
...
//            log.info("Freemem before="+ freeMemBefore +"; Freemem after="+ freeMemAfter + "; change="+(freeMemAfter-freeMemBefore));
        }
