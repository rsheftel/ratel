...
public class Fix2CmfUtil
{
    ...
    private static final Map<PairKey<TradingPlatform, String>, String> primeBroker = new HashMap<PairKey<TradingPlatform, String>, String>();
    ...
    {
        List<PairKey<PairKey<TradingPlatform, String>, String>> mappings = jdbcTemplate.query(
            PRIME_BROKER_SELECT, new PrimeBrokerRowMapper());

        for (PairKey<PairKey<TradingPlatform, String>, String> tableEntry : mappings)
        {
            PairKey<TradingPlatform, String> key = tableEntry.firstPart;
    ...
    private static class Bic2BbcRowMapper implements ParameterizedRowMapper<String[]>
    {
        public String[] mapRow (ResultSet rs, int rowNum) throws SQLException
        {
            String bic = rs.getString("BIC").toUpperCase();
            String bbc = rs.getString("BloombergCode").toUpperCase();
    ...
    private static class PrimeBrokerRowMapper implements
        ParameterizedRowMapper<PairKey<PairKey<TradingPlatform, String>, String>>
    {
        public PairKey<PairKey<TradingPlatform, String>, String> mapRow (ResultSet rs, int rowNum)
            throws SQLException
        {
            TradingPlatform platform = TradingPlatform.valueFor(rs.getString("PLATFORM_ID")
                .toUpperCase());
            ...
            PairKey<PairKey<TradingPlatform, String>, String> tableEntry = new PairKey<PairKey<TradingPlatform, String>, String>(
                key, execBroker);
