...
public enum AccountType
{
    ...
    TBA("TBA", "Mortgages"), Government("GOVT", "Government"), Unknown("TEST", "Test/Unknown");
    ...
    public static AccountType valueFor (String text)
    {
        ...
        else if (Government.getText().equals(text))
        {
            return Government;
        }
        else
    ...
    public static AccountType valueForLongText (String text)
    {
        ...
        else if (Government.getLongText().equals(text))
        {
            return Government;
        }
        else
