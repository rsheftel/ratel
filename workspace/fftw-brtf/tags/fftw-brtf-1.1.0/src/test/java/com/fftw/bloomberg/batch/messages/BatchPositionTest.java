...
//            "/Transaction200-2008-06-05.txt"
    ...
    private boolean matches(String fileValue) {
        //return (fileValue.startsWith("TU") || fileValue.startsWith("TY") || fileValue.startsWith("FV") || fileValue.startsWith("US"));
        //return (fileValue.startsWith("JY") || fileValue.startsWith("NG"));
        //return (fileValue.startsWith("CD") || fileValue.startsWith("CD"));
//        return (fileValue.startsWith("AD") || fileValue.startsWith("CD") || fileValue.startsWith("FV") || fileValue.startsWith("TU")
...
// additonal fields
    ...
    public void testAggregatable() {
        ...
        BatchPosition otherFail = new BatchPosition(new LocalDate(), "AAPL", "UnitTest", "Level1", "Level2", "Level3", "Level9");
    ...
    public void testAggregate() {
        ...
        assert (result.getFullCurrentNetPosition().compareTo(bp.getFullCurrentNetPosition()) == 0
                && result.getFullCurrentNetPositionWithoutComma().compareTo(bp.getFullCurrentNetPositionWithoutComma()) == 0
                && result.getCurrentLongPosition().compareTo(bp.getCurrentLongPosition()) == 0
                && result.getCurrentShortPosition().compareTo(bp.getCurrentShortPosition()) == 0) : "Failed to aggregate";
        ...
        assert (result.getFullCurrentNetPosition().compareTo(new BigDecimal ("100.23")) == 0
                ...
                && result.getCurrentLongPosition().compareTo(new BigDecimal("180")) == 0
                && result.getCurrentShortPosition().compareTo(new BigDecimal("178")) == 0) : "Failed to aggregate";
        ...
        assert (result.getFullCurrentNetPosition().compareTo(new BigDecimal ("7200000.0000")) == 0
                ...
                && result.getCurrentLongPosition().compareTo(new BigDecimal("0")) == 0
                && result.getCurrentShortPosition().compareTo(new BigDecimal("0")) == 0) : "Failed to aggregate";
