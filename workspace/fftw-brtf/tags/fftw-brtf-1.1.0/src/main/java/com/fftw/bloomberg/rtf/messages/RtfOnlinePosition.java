 ...
 */
public class RtfOnlinePosition implements RtfMessageTradeBody, PositionRecord, Aggregatable<RtfOnlinePosition> {
    ...
    private RtfOnlinePosition copy() {
        RtfOnlinePosition localCopy = new RtfOnlinePosition(securityId, account, level1TagName, level2TagName,
