...
public class RtfOnlinePosition implements RtfMessageTradeBody, PositionRecord {
    ...
    void setLevel1TagName(String name) {
        level1TagName = name;
    }
    ...
    void setLevel2TagName(String name) {
        level1TagName = name;
    }
    ...
    void setLevel3TagName(String name) {
        level3TagName = name;
    }
    ...
    void setLevel4TagName(String name) {
        level4TagName = name;
    }
     ...
     */
    /*
     * public boolean aggregatable(RtfOnlinePosition other) { boolean canAggregateForRedi =
     * securityId.equals(other.securityId) && account.equals(other.account); boolean canAggregateForAim =
     ...
     * 
     * // A little redundant, but it represents what the rules are return canAggregateForRedi ||
     * (canAggregateForRedi && canAggregateForAim); }
     */
    RtfOnlinePosition copy() {
    ...
    public String toReconString() {
        ...
        sb.append("SHARESBOUGHT=").append(normalizeShares(getTotalBuyVolume())).append("|");
        sb.append("SHARESSOLD=").append(normalizeShares(getTotalSellVolume())).append("|");
        sb.append("OPENSHARES=").append(normalizeShares(getOpenPosition())).append("|");

        sb.append("RIC=").append(ric == null ? "" : ric).append("|");
        sb.append("CURRENTPOSITION=").append(normalizeShares(getCurrentPosition())).append("|");
        
        long interaDayNetPosition = getTotalBuyVolume().longValue() - getTotalSellVolume().longValue();
        sb.append("POSITION=").append(normalizeShares(interaDayNetPosition)).append("|");
    ...
    private long normalizeShares(BigDecimal shareVolume) {
        return normalizeShares(shareVolume.longValue());
    }

    private long normalizeShares(long shareVolume) {
        switch (productCode) {
            case Equity:
            case Index:
                return shareVolume;
            default:
                return shareVolume / contractSize.longValue();
        }
    }
