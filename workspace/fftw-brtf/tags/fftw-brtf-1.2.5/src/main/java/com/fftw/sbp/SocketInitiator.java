...
public class SocketInitiator {
    ...
    public SocketInitiator(RealtimeApplication app, ProtocolSession<RealtimeSessionID, RtfMessage> session, ProtocolSessionConfig sessionConfig, String timerThreadName) {
    ...
    public SocketInitiator(RealtimeApplication app, ProtocolSession<RealtimeSessionID, RtfMessage> session, ProtocolSessionConfig sessionConfig) {
