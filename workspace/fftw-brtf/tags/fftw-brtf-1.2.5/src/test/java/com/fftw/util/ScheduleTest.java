...
public class ScheduleTest {
    ...
    public void testInitializeFromPropertiesDefaultWeekend() {
        ...
        DateTime startTime = new DateTime(now.getYear(), now.getMonthOfYear(), now.getDayOfMonth(), 7, 0, 0,
            0);
    ...
    public void testInitializeFromPropertiesSpecialWeekend() {
        ...
        try {
            ...
            DateTime now = new DateTime();
            DateTime startTime = new DateTime(now.getYear(), now.getMonthOfYear(), now.getDayOfMonth(), 7, 0,
                0, 0);
