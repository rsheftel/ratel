...
public class ReconAggregationStrategyTest {
    private String[] BATCHFILES = { "/OnlineMessages-2009-03-11.txt" };

    @Test(groups = { "unittest" })
    public void testAddingItem() {

        OnlinePositionAggregationCache<OnlinePositionKey> cache = new OnlinePositionAggregationCache<OnlinePositionKey>(new ReconAggregationStrategy());
    ...
    public void testFileReplay() {
        ...
        try {
            for (String filename : BATCHFILES) {
                ...
                InputStream onlinePositionStream = ReconAggregationStrategyTest.class
            ...
            RtfOnlinePosition bph9 = cache.getOnlinePosition(new ReconOnlineRecordKey("BPH9", BBProductCode.Currency, "QMF"));
            assertNotNull(bph9);
