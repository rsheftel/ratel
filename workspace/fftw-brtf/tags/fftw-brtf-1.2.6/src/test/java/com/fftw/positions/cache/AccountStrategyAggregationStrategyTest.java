...
public class AccountStrategyAggregationStrategyTest {
    private String[] BATCHFILES = { "/OnlineMessages-2009-03-11.txt" };

    @Test(groups = { "unittest" })
    public void testAddingItem() {

        OnlinePositionAggregationCache<OnlinePositionKey> cache = new OnlinePositionAggregationCache<OnlinePositionKey>(new AccountStrategyAggregationStrategy());
    ...
    public void testFileReplay() {
        ...
        try {
            for (String filename : BATCHFILES) {
                ...
                InputStream onlinePositionStream = AccountStrategyAggregationStrategyTest.class
