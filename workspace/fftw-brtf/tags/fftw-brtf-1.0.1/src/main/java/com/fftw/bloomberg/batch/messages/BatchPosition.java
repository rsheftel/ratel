 ...
 * </ol>
 */
public class BatchPosition implements PositionRecord {
    ...
    private String transactinCounterparty;
    ...
    public static BatchPosition valueOf(LocalDate batchFileDate, String rawString) {
        ...
        position.transactinCounterparty = extractString(rawString, 178, 187);
...
//        return positionName;
    ...
    public String toTextMessage(String delimiter) {
        ...
        sb.append(delimiter).append("transactinCounterparty=").append(emptyStringOrValue(transactinCounterparty));
...
//        }
    ...
    public String getTransactinCounterparty() {
        return transactinCounterparty;
    }
