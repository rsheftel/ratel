...
public class OnlinePositionKey {
    ...
    private final Long openPosition;
    ...
    public OnlinePositionKey(String securityId, String account, String level1TagName, String level2TagName,
                       String level3TagName, String level4TagName, BigDecimal openPosition, String primeBroker) {
        ...
        this.openPosition = openPosition.longValue();
    ...
    public int hashCode() {
        ...
        hashCode = hashCode + (17 * openPosition.intValue()) + (17 * primeBroker.hashCode());
