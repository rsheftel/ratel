...
public class ExcelPositionCacheTest extends AbstractCacheTest {
    ...
    private static final int BATCH_FILE_RECORD_COUNT = 1040;
    ...
    public void testExcelPositionCacheBatchFileLoad() {
        ...
        Collection<BatchPosition> batchPositions = epc.batchValues();
        assertEquals(batchPositions.size(), 1040);
        
//        for (BatchPosition key : batchPositions) {
...
//        }
    ...
    public void testExcelPositionCacheOnlineFileLoad() {
        ...
        for (RtfOnlinePosition position : onlineValues) {
