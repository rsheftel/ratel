...
public class PositionKeyTest {
    ...
    public void testEquals() {
        ...
        // Using BigDecimal
        PositionKey key01 = new PositionKey("", BBProductCode.Equity, "UnitTest", "Level1", "Level2", "Level3", "Level4", null, new BigDecimal("10.010"));
        PositionKey key02 = new PositionKey("", BBProductCode.Equity, "UnitTest", "Level1", "Level2", "Level3", "Level4", null, new BigDecimal("10.01"));
        
        assertEquals(key01, key02);
