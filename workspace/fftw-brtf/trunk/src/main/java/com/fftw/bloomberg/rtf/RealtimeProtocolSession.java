...
public class RealtimeProtocolSession implements ProtocolSession<RealtimeSessionID, RtfMessage> {
    ...
    //private SessionApplication<RealtimeProtocolSession, Object> application;
    private RealtimeApplication application;
    ...
    private ProtocolIoHandler<RealtimeSessionID, RtfMessage> ioHandler;

    private MessageStore<RtfMessage> messageStore;
    ...
    RealtimeProtocolSession(RealtimeApplication app, Properties props, ProtocolIoHandler<RealtimeSessionID, RtfMessage> ioHandler) {
    ...
    private MessageStore<RtfMessage> configureMessageStore(Properties props) {
        ...
        if (persitMessages) {
            ...
            return new MemoryMessageStore<RtfMessage>();
        }
    }
    ...
    public void setIoHandler(ProtocolIoHandler<RealtimeSessionID, RtfMessage> ioHandler) {
        this.ioHandler = ioHandler;
    }
