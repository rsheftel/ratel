...
public class ConnectTask extends Observable implements Runnable {
    ...
    private final ProtocolSession<RealtimeSessionID, RtfMessage> protocolSession;
    ...
    public ConnectTask(ProtocolSession<RealtimeSessionID, RtfMessage> protocolSession, ProtocolSessionConfig sessionConfig) {
