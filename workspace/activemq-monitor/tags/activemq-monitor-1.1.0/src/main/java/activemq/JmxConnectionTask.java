...
public class JmxConnectionTask {
    ...
    public MBeanServerConnection getMBeanConnection() {
        try {
            ...
            log.error("Unable to get MBean connection", e);
            throw new JmxException("Unable to get MBean connection", e);
        }
    }
    ...
    public void stop() {
        ...
        if (connector != null) {
            try {
                ...
                throw new JmxException("Cannot close connect", e);
            }
        }
    }
}
