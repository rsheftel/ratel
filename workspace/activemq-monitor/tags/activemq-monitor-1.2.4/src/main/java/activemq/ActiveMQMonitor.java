...
//     private static final String HOST_NAME = "nysrv61";
    ...
    // TODO Put this into the configuration object
    public static final String BROKER_URL = "tcp://" + HOST_NAME + ":" + TCP_PORT + FAILOVER_CONFIG;
    ...
    protected void startup() {
        ...
        branchMenu.add(actionMap.get("refreshTopics"));
        // branchMenu.add(actionMap.get("removeTopic"));

        topicTree.addMouseListener(new NodeMouseListener(leafMenu, branchMenu));
    ...
    protected void ready() {
        ...
        final ProgressMonitor progressMonitor = new ProgressMonitor(application.getMainFrame(),
                 "Loading initial topics", "", 0, 100);

        TaskService defaultService = Application.getInstance().getContext().getTaskService();
        defaultService.execute(new LoadTopicsTask(this, progressMonitor));
    ...
    private final class NodeMouseListener extends MouseAdapter {
        ...
        private final JPopupMenu branchMenu;

        public NodeMouseListener(JPopupMenu leafMenu, JPopupMenu branchMenu) {
        ...
        private void maybeShowPopup(MouseEvent e) {
            ...
            } else if (e.isPopupTrigger() && haveBranchNode()) {
                branchMenu.show(e.getComponent(), e.getX(), e.getY());
        ...
        private boolean haveBranchNode() {
            return selectedTreeNode != null && !selectedTreeNode.isLeaf();
        }
    }
    ...
    public AdvisoryMessageMonitor getAdvisoryMessageMonitor() {
        return advisoryMonitor;
    }

    public void setTopicTreeModel(TopicTreeModel topicTreeModel) {
        this.topicTree.setModel(topicTreeModel);
        this.treeModel = topicTreeModel;
