...
public abstract class AbstractTableCellRenderer extends JLabel implements TableCellRenderer,
    ...
    protected abstract void overrideCellColor(JTable table, Object value, boolean isSelected,
    ...
    protected boolean isCellDropTarget(JTable.DropLocation dropLocation, int row, int column) {
        return (dropLocation != null && !dropLocation.isInsertRow() && !dropLocation.isInsertColumn()
    ...
    protected Color blend(Color base, Color other) {
        ...
        Color blendedColor = new Color(ensureValidComponent(base.getRed() + r), ensureValidComponent(base
                .getGreen()
                + g), ensureValidComponent(base.getBlue() + b));
    ...
    protected Color darker(Color base, double factor) {
        return new Color(ensureValidComponent(base.getRed() * factor), ensureValidComponent(base.getGreen()
                * factor), ensureValidComponent(base.getBlue() * factor));
    }
    ...
    protected Color brighter(Color base, double factor) {
        ...
        /*
         * From 2D group: 1. black.brighter() should return grey 2. applying brighter to blue will always
         * return blue, brighter 3. non pure color (non zero rgb) will eventually return white
         */
        ...
        return new Color(ensureValidComponent(r / factor), ensureValidComponent(g / factor),
