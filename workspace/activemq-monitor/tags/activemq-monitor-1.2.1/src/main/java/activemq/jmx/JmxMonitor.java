...
public class JmxMonitor {
    ...
    public List<TopicViewMBean> listTopics() {
        try {
            ...
            return this.<TopicViewMBean> getManagedObjects(topics, TopicViewMBean.class, pattern);
    ...
    protected <T> List<T> getManagedObjects(ObjectName[] names, Class<T> type, ObjectName pattern) {
