...
public class ActiveMQStressTest implements ExceptionListener {
    ...
    @BeforeMethod(groups = { "stresstest" })
    public void startJvm() throws Exception {
        ...
        String[] command = { javaHome + "/bin/java", "-Dcom.sun.management.jmxremote", "-Xmx256M",
        ...
        Monitoring.sleep(startupDelay * 1000); // delay in seconds
    }

    @AfterMethod(groups = { "stresstest" })
    public void stopJvm() {
        localProcess.kill();
