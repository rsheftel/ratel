...
final class TestDestinationMBean implements DestinationViewMBean {
    
    private String name;
    
    public TestDestinationMBean(String name) {
        this.name = name;
    }
    ...
    @Override
    public TabularData browseAsTable(String selector) throws OpenDataException,
            InvalidSelectorException {
        if (true) {
           throw new UnsupportedOperationException("Implement me!");
        }
