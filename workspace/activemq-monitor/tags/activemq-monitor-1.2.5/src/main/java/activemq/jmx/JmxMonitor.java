...
public class JmxMonitor {
    ...
    public List<DestinationViewMBean> listQueues(IObserver<Integer> observer) {
        try {
            ObjectName[] topics = brokerView.getQueues();
            ObjectName pattern = new ObjectName("org.apache.activemq:*");

            return this.<DestinationViewMBean> getManagedObjects(topics, DestinationViewMBean.class, pattern, observer);
    ...
    public List<DestinationViewMBean> listTopics(IObserver<Integer> observer) {
        try {
            ObjectName[] topics = brokerView.getTopics();
            ObjectName pattern = new ObjectName("org.apache.activemq:*"); // ,Type=Topic
    ...
    public List<DestinationViewMBean> listTopics() {
