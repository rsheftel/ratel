...
public class ActiveMQServerMonitor extends AbstractTopicMonitor<IJmsObserver<Message>, Message> implements
    ...
    public ActiveMQServerMonitor(ConnectionTask connection) {
        ...
        this.brokerUrl = connection.getBrokerUrl();
    }
    ...
    boolean sendReconnectEmail() {
        ...
        sb.append("Monitor has reconnected to ActiveMQ ").append(brokerUrl).append("\n");
    ...
    boolean sendDisconnectEmail(ConnectionEvent connectionEvent) {
        ...
        sb.append("Monitor Disconnected from server ").append(brokerUrl).append("\n");
    ...
    boolean sendFailedConnectionEmail(String brokerUrl) {
        ...
        sb.append("Failed to create new connection to server ").append(brokerUrl).append("\n");
    ...
    public boolean sendLowMemoryEmail(MemoryUsage memoryUsage, double thresholdPercent) {
        EmailSender emailSender = new EmailSender(emailSettings);
        StringBuilder sb = new StringBuilder(128);

        sb.append("ActiveMQ Memory is low :").append(brokerUrl).append("\n");
    ...
    boolean sendShutdownEmail() {
        ...
        sb.append("Monitor is shutting down ").append(brokerUrl).append("\n");
    ...
    public boolean sendHighThreadEmail(ThreadCountInfo tci, long threadThreshold) {
        ...
        sb.append("ActiveMQ Thread Count is High on ").append(brokerUrl).append("\n");
    ...
    public boolean sendExceptionEmail(String subject, Exception e) {
        EmailSender emailSender = new EmailSender(emailSettings);
        StringBuilder sb = new StringBuilder(128);

        sb.append("ActiveMQ exception on ").append(brokerUrl).append("\n");
        sb.append(exceptionToString(e));
        
        return emailSender.sendMessage(subject, sb.toString());
    }
