...
public class MultiBrokerTreeModel extends DefaultTreeModel {
    ...
    public synchronized DestinationTreeNode addDestination(String brokerName, DestinationViewMBean newDestination) {
    ...
    public synchronized void addDestinations(List<DestinationViewMBean> destList, IObserver<Integer> observer, BrokerConfiguration brokerConfig) {
    ...
    public synchronized BrokerTreeNode removeBrokerNode(String brokerName) {
        BrokerTreeNode brokerNode = getBrokerNode(brokerName);
        if (brokerNode != null) {
    ...
    public synchronized void addBroker(BrokerTreeNode brokerNode) {
