...
public class ActiveMQMonitor extends Application implements IJmsObserver<ActiveMQMessage>, IConfigurable {
    ...
    protected void startup() {
        ...
        ActionMap nodeActionMap = getContext().getActionMap(new TreeActions());
        JPopupMenu nodeMenu = new JPopupMenu();
        nodeMenu.add(nodeActionMap.get("removeTopic"));
        ...
        topicTree.addMouseListener(new NodeMouseListener(brokerMenu, nodeMenu, leafMenu));
    ...
    @Override
    public synchronized void onUpdate(Object source, ActiveMQMessage message) {
    ...
    private final class NodeMouseListener extends MouseAdapter {
        ...
        public NodeMouseListener(JPopupMenu brokerMenu, JPopupMenu nodeMenu, JPopupMenu leafMenu) {
        ...
        private void maybeShowPopup(MouseEvent e) {
            ...
            } else if (e.isPopupTrigger() && isOnlyNode()) {
        ...
        private boolean isOnlyNode() {
            if (selectedTreeNodes.size() > 0) {
                ...
                for (TreePath treePath : selectedTreeNodes) {
                    ...
                    allLeafNodes = allLeafNodes && (selectedTreeNode instanceof HierarchicalTreeNode);
                }
                return allLeafNodes;
            } else {
