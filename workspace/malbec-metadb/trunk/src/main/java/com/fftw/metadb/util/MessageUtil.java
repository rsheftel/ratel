...
public class MessageUtil {
    ...
    static final Logger staticLogger = LoggerFactory.getLogger(MessageUtil.class);
    ...
    private static DateTimeFormatter recordDateFormat = DateTimeFormat.forPattern("yyyy/MM/dd HH:mm:ss.SSS ZZ");
    ...
    public static Map<String, String> extractRecord(String rawString, String sep, Map<String, String> record) {
        ...
        for (String token : parts) {
            ...
            if (keyValue != null && keyValue.length > 1) {
                ...
                staticLogger.warn("Unable to parse message field:" + token);
            }
        }
