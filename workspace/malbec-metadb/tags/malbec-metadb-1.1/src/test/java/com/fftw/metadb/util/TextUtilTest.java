...
public class TextUtilTest {
    ...
    public void testExtractRecord() {
        Map<String, String> result = TextUtil.extractRecord(STRING_MESSAGE, "\\|", new LinkedHashMap<String, String>());

        assert TextUtil.compareMaps(MAP_MESSAGE, result) : "Parsed string incorrectly";
    }
    ...
    public void testCreateRecord() {
        ...
        String recordString = TextUtil.createRecord(MAP_MESSAGE, "|");
    ...
    public void testFormatDate() {
        // This routine is bad, it adds 1900 tot he year, so I must remove it
        Date testDate = new Date(108, 05, 20);
        String formattedDate = TextUtil.formatDate(testDate);
