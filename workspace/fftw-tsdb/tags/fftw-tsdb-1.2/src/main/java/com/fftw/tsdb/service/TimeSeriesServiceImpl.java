...
public class TimeSeriesServiceImpl implements TimeSeriesService
{
        ...
        DataSource dataSource)
    {
        for (TimeSeriesSdo timeSeriesSdo : timeSeriesSdos)
        {
            if (timeSeriesSdo.getObservationValue() != null)
            {
                ...
                try
                {
                    // TODO is there a way to suppress logging of the exception?
                    // maybe catch it at the dao layer?
                ...
                /*
                 * //TODO doing the try/catch entity exists exception at dao
                 * level timeSeriesDataDao.persist(timeSeriesData);
                 */
            }
        }
        if (logger.isDebugEnabled())
    ...
    {
        dataSourceName = dataSourceName.toLowerCase();
        return timeSeriesDao.findDataByDateRange(timeSeriesName, dataSourceName, new Date(startDate
