...
public class ArbitrationServiceImpl implements ArbitrationService
{
    ...
    public ArbitrationServiceImpl ()
    {
        ...
        timeSeriesService = new TimeSeriesServiceImpl();
    }
    ...
    public void cdsArbitration (Calendar calArbitration) throws IOException
    {
        ...
        for (Iterator<Long> i = listTimeSeriesIDs.iterator(); i.hasNext();)
        {
            ...
            TimeSeries timeSeries = timeSeriesService.findByID(timeSeriesID);
            boolean bFoundInMarkit = false;
            try
            {
                List<TimeSeriesData> listTSD = timeSeriesService.findDataByDateRange(timeSeries
                ...
                if (bFoundInMarkit)
                {
                    ...
                    timeSeriesService.createOrUpdateTimeSeriesData(timeSeries, strInternal,
