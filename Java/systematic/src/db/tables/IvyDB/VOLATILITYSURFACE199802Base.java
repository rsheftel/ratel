...
public class VOLATILITYSURFACE199802Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199802Base T_VOLATILITY_SURFACE_1998_02 = new VOLATILITYSURFACE199802Base("VOLATILITY_SURFACE_1998_02base");

    public VOLATILITYSURFACE199802Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_02", alias); }
