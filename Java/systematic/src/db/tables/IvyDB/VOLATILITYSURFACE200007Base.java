...
public class VOLATILITYSURFACE200007Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200007Base T_VOLATILITY_SURFACE_2000_07 = new VOLATILITYSURFACE200007Base("VOLATILITY_SURFACE_2000_07base");

    public VOLATILITYSURFACE200007Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2000_07", alias); }
