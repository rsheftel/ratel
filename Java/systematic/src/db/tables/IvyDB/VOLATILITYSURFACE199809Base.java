...
public class VOLATILITYSURFACE199809Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199809Base T_VOLATILITY_SURFACE_1998_09 = new VOLATILITYSURFACE199809Base("VOLATILITY_SURFACE_1998_09base");

    public VOLATILITYSURFACE199809Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_09", alias); }
