...
public class VOLATILITYSURFACE200102Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200102Base T_VOLATILITY_SURFACE_2001_02 = new VOLATILITYSURFACE200102Base("VOLATILITY_SURFACE_2001_02base");

    public VOLATILITYSURFACE200102Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_02", alias); }
