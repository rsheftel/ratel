...
public class VOLATILITYSURFACE199812Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199812Base T_VOLATILITY_SURFACE_1998_12 = new VOLATILITYSURFACE199812Base("VOLATILITY_SURFACE_1998_12base");

    public VOLATILITYSURFACE199812Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_12", alias); }
