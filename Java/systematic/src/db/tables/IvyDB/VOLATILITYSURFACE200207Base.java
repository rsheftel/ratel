...
public class VOLATILITYSURFACE200207Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200207Base T_VOLATILITY_SURFACE_2002_07 = new VOLATILITYSURFACE200207Base("VOLATILITY_SURFACE_2002_07base");

    public VOLATILITYSURFACE200207Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_07", alias); }
