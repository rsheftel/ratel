...
public class VOLATILITYSURFACE200307Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200307Base T_VOLATILITY_SURFACE_2003_07 = new VOLATILITYSURFACE200307Base("VOLATILITY_SURFACE_2003_07base");

    public VOLATILITYSURFACE200307Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_07", alias); }
