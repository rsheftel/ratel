...
public class VOLATILITYSURFACE199603Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199603Base T_VOLATILITY_SURFACE_1996_03 = new VOLATILITYSURFACE199603Base("VOLATILITY_SURFACE_1996_03base");

    public VOLATILITYSURFACE199603Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1996_03", alias); }
