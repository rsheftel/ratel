...
public class VOLATILITYSURFACE200109Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200109Base T_VOLATILITY_SURFACE_2001_09 = new VOLATILITYSURFACE200109Base("VOLATILITY_SURFACE_2001_09base");

    public VOLATILITYSURFACE200109Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_09", alias); }
