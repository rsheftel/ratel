...
public class VOLATILITYSURFACE200202Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200202Base T_VOLATILITY_SURFACE_2002_02 = new VOLATILITYSURFACE200202Base("VOLATILITY_SURFACE_2002_02base");

    public VOLATILITYSURFACE200202Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_02", alias); }
