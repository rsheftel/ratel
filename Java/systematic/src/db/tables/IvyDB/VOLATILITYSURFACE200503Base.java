...
public class VOLATILITYSURFACE200503Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200503Base T_VOLATILITY_SURFACE_2005_03 = new VOLATILITYSURFACE200503Base("VOLATILITY_SURFACE_2005_03base");

    public VOLATILITYSURFACE200503Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_03", alias); }
