...
public class VOLATILITYSURFACE200806Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200806Base T_VOLATILITY_SURFACE_2008_06 = new VOLATILITYSURFACE200806Base("VOLATILITY_SURFACE_2008_06base");

    public VOLATILITYSURFACE200806Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2008_06", alias); }
