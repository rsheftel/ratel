...
public class VOLATILITYSURFACE200101Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200101Base T_VOLATILITY_SURFACE_2001_01 = new VOLATILITYSURFACE200101Base("VOLATILITY_SURFACE_2001_01base");

    public VOLATILITYSURFACE200101Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_01", alias); }
