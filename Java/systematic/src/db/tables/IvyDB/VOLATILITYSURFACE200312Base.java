...
public class VOLATILITYSURFACE200312Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200312Base T_VOLATILITY_SURFACE_2003_12 = new VOLATILITYSURFACE200312Base("VOLATILITY_SURFACE_2003_12base");

    public VOLATILITYSURFACE200312Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_12", alias); }
