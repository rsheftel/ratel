...
public class VOLATILITYSURFACE200508Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200508Base T_VOLATILITY_SURFACE_2005_08 = new VOLATILITYSURFACE200508Base("VOLATILITY_SURFACE_2005_08base");

    public VOLATILITYSURFACE200508Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_08", alias); }
