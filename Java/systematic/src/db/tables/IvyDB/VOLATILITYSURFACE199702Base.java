...
public class VOLATILITYSURFACE199702Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199702Base T_VOLATILITY_SURFACE_1997_02 = new VOLATILITYSURFACE199702Base("VOLATILITY_SURFACE_1997_02base");

    public VOLATILITYSURFACE199702Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_02", alias); }
