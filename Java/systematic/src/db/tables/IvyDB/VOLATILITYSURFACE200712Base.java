...
public class VOLATILITYSURFACE200712Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200712Base T_VOLATILITY_SURFACE_2007_12 = new VOLATILITYSURFACE200712Base("VOLATILITY_SURFACE_2007_12base");

    public VOLATILITYSURFACE200712Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_12", alias); }
