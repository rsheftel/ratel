...
public class VOLATILITYSURFACE200308Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200308Base T_VOLATILITY_SURFACE_2003_08 = new VOLATILITYSURFACE200308Base("VOLATILITY_SURFACE_2003_08base");

    public VOLATILITYSURFACE200308Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_08", alias); }
