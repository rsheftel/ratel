...
public class VOLATILITYSURFACE199601Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199601Base T_VOLATILITY_SURFACE_1996_01 = new VOLATILITYSURFACE199601Base("VOLATILITY_SURFACE_1996_01base");

    public VOLATILITYSURFACE199601Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1996_01", alias); }
