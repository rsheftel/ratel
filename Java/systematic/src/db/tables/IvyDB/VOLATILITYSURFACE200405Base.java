...
public class VOLATILITYSURFACE200405Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200405Base T_VOLATILITY_SURFACE_2004_05 = new VOLATILITYSURFACE200405Base("VOLATILITY_SURFACE_2004_05base");

    public VOLATILITYSURFACE200405Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_05", alias); }
