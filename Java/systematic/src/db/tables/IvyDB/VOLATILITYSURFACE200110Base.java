...
public class VOLATILITYSURFACE200110Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200110Base T_VOLATILITY_SURFACE_2001_10 = new VOLATILITYSURFACE200110Base("VOLATILITY_SURFACE_2001_10base");

    public VOLATILITYSURFACE200110Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_10", alias); }
