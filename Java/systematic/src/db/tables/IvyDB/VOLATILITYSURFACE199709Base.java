...
public class VOLATILITYSURFACE199709Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199709Base T_VOLATILITY_SURFACE_1997_09 = new VOLATILITYSURFACE199709Base("VOLATILITY_SURFACE_1997_09base");

    public VOLATILITYSURFACE199709Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_09", alias); }
