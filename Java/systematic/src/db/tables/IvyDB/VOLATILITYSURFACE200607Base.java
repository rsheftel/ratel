...
public class VOLATILITYSURFACE200607Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200607Base T_VOLATILITY_SURFACE_2006_07 = new VOLATILITYSURFACE200607Base("VOLATILITY_SURFACE_2006_07base");

    public VOLATILITYSURFACE200607Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_07", alias); }
