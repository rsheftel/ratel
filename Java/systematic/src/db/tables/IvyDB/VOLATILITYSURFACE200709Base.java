...
public class VOLATILITYSURFACE200709Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200709Base T_VOLATILITY_SURFACE_2007_09 = new VOLATILITYSURFACE200709Base("VOLATILITY_SURFACE_2007_09base");

    public VOLATILITYSURFACE200709Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_09", alias); }
