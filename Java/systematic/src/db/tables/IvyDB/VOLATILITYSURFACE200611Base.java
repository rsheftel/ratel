...
public class VOLATILITYSURFACE200611Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200611Base T_VOLATILITY_SURFACE_2006_11 = new VOLATILITYSURFACE200611Base("VOLATILITY_SURFACE_2006_11base");

    public VOLATILITYSURFACE200611Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_11", alias); }
