...
public class VOLATILITYSURFACE200710Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200710Base T_VOLATILITY_SURFACE_2007_10 = new VOLATILITYSURFACE200710Base("VOLATILITY_SURFACE_2007_10base");

    public VOLATILITYSURFACE200710Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_10", alias); }
