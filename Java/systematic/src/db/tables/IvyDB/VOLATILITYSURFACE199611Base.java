...
public class VOLATILITYSURFACE199611Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199611Base T_VOLATILITY_SURFACE_1996_11 = new VOLATILITYSURFACE199611Base("VOLATILITY_SURFACE_1996_11base");

    public VOLATILITYSURFACE199611Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1996_11", alias); }
