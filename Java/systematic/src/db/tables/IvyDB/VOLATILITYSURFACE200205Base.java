...
public class VOLATILITYSURFACE200205Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200205Base T_VOLATILITY_SURFACE_2002_05 = new VOLATILITYSURFACE200205Base("VOLATILITY_SURFACE_2002_05base");

    public VOLATILITYSURFACE200205Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_05", alias); }
