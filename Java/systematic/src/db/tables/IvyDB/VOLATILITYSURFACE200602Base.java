...
public class VOLATILITYSURFACE200602Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200602Base T_VOLATILITY_SURFACE_2006_02 = new VOLATILITYSURFACE200602Base("VOLATILITY_SURFACE_2006_02base");

    public VOLATILITYSURFACE200602Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_02", alias); }
