...
public class VOLATILITYSURFACE200702Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200702Base T_VOLATILITY_SURFACE_2007_02 = new VOLATILITYSURFACE200702Base("VOLATILITY_SURFACE_2007_02base");

    public VOLATILITYSURFACE200702Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_02", alias); }
