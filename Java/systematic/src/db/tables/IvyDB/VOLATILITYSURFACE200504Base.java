...
public class VOLATILITYSURFACE200504Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200504Base T_VOLATILITY_SURFACE_2005_04 = new VOLATILITYSURFACE200504Base("VOLATILITY_SURFACE_2005_04base");

    public VOLATILITYSURFACE200504Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_04", alias); }
