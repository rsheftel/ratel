...
public class VOLATILITYSURFACE199811Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199811Base T_VOLATILITY_SURFACE_1998_11 = new VOLATILITYSURFACE199811Base("VOLATILITY_SURFACE_1998_11base");

    public VOLATILITYSURFACE199811Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_11", alias); }
