...
public class VOLATILITYSURFACE199905Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199905Base T_VOLATILITY_SURFACE_1999_05 = new VOLATILITYSURFACE199905Base("VOLATILITY_SURFACE_1999_05base");

    public VOLATILITYSURFACE199905Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_05", alias); }
