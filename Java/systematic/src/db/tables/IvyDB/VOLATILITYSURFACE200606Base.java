...
public class VOLATILITYSURFACE200606Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200606Base T_VOLATILITY_SURFACE_2006_06 = new VOLATILITYSURFACE200606Base("VOLATILITY_SURFACE_2006_06base");

    public VOLATILITYSURFACE200606Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_06", alias); }
