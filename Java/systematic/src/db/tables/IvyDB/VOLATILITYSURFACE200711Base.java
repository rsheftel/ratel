...
public class VOLATILITYSURFACE200711Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200711Base T_VOLATILITY_SURFACE_2007_11 = new VOLATILITYSURFACE200711Base("VOLATILITY_SURFACE_2007_11base");

    public VOLATILITYSURFACE200711Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_11", alias); }
