...
public class VOLATILITYSURFACE200002Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200002Base T_VOLATILITY_SURFACE_2000_02 = new VOLATILITYSURFACE200002Base("VOLATILITY_SURFACE_2000_02base");

    public VOLATILITYSURFACE200002Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2000_02", alias); }
