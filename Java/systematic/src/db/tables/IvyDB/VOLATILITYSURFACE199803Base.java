...
public class VOLATILITYSURFACE199803Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199803Base T_VOLATILITY_SURFACE_1998_03 = new VOLATILITYSURFACE199803Base("VOLATILITY_SURFACE_1998_03base");

    public VOLATILITYSURFACE199803Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_03", alias); }
