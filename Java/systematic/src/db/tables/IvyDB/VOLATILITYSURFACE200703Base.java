...
public class VOLATILITYSURFACE200703Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200703Base T_VOLATILITY_SURFACE_2007_03 = new VOLATILITYSURFACE200703Base("VOLATILITY_SURFACE_2007_03base");

    public VOLATILITYSURFACE200703Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_03", alias); }
