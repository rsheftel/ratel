...
public class VOLATILITYSURFACE200403Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200403Base T_VOLATILITY_SURFACE_2004_03 = new VOLATILITYSURFACE200403Base("VOLATILITY_SURFACE_2004_03base");

    public VOLATILITYSURFACE200403Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_03", alias); }
