...
public class VOLATILITYSURFACE200301Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200301Base T_VOLATILITY_SURFACE_2003_01 = new VOLATILITYSURFACE200301Base("VOLATILITY_SURFACE_2003_01base");

    public VOLATILITYSURFACE200301Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_01", alias); }
