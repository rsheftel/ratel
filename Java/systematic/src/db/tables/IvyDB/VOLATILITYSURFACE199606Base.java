...
public class VOLATILITYSURFACE199606Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199606Base T_VOLATILITY_SURFACE_1996_06 = new VOLATILITYSURFACE199606Base("VOLATILITY_SURFACE_1996_06base");

    public VOLATILITYSURFACE199606Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1996_06", alias); }
