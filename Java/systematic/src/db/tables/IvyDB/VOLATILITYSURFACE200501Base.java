...
public class VOLATILITYSURFACE200501Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200501Base T_VOLATILITY_SURFACE_2005_01 = new VOLATILITYSURFACE200501Base("VOLATILITY_SURFACE_2005_01base");

    public VOLATILITYSURFACE200501Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_01", alias); }
