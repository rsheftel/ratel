...
public class VOLATILITYSURFACE200705Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200705Base T_VOLATILITY_SURFACE_2007_05 = new VOLATILITYSURFACE200705Base("VOLATILITY_SURFACE_2007_05base");

    public VOLATILITYSURFACE200705Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_05", alias); }
