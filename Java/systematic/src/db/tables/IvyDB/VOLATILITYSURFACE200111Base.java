...
public class VOLATILITYSURFACE200111Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200111Base T_VOLATILITY_SURFACE_2001_11 = new VOLATILITYSURFACE200111Base("VOLATILITY_SURFACE_2001_11base");

    public VOLATILITYSURFACE200111Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_11", alias); }
