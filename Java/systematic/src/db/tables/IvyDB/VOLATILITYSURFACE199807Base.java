...
public class VOLATILITYSURFACE199807Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199807Base T_VOLATILITY_SURFACE_1998_07 = new VOLATILITYSURFACE199807Base("VOLATILITY_SURFACE_1998_07base");

    public VOLATILITYSURFACE199807Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_07", alias); }
