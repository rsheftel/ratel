...
public class VOLATILITYSURFACE200204Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200204Base T_VOLATILITY_SURFACE_2002_04 = new VOLATILITYSURFACE200204Base("VOLATILITY_SURFACE_2002_04base");

    public VOLATILITYSURFACE200204Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_04", alias); }
