...
public class VOLATILITYSURFACE200103Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200103Base T_VOLATILITY_SURFACE_2001_03 = new VOLATILITYSURFACE200103Base("VOLATILITY_SURFACE_2001_03base");

    public VOLATILITYSURFACE200103Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_03", alias); }
