...
public class VOLATILITYSURFACE199605Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199605Base T_VOLATILITY_SURFACE_1996_05 = new VOLATILITYSURFACE199605Base("VOLATILITY_SURFACE_1996_05base");

    public VOLATILITYSURFACE199605Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1996_05", alias); }
