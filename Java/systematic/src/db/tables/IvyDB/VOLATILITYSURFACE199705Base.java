...
public class VOLATILITYSURFACE199705Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199705Base T_VOLATILITY_SURFACE_1997_05 = new VOLATILITYSURFACE199705Base("VOLATILITY_SURFACE_1997_05base");

    public VOLATILITYSURFACE199705Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_05", alias); }
