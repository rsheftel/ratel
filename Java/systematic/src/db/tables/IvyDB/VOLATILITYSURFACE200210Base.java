...
public class VOLATILITYSURFACE200210Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200210Base T_VOLATILITY_SURFACE_2002_10 = new VOLATILITYSURFACE200210Base("VOLATILITY_SURFACE_2002_10base");

    public VOLATILITYSURFACE200210Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_10", alias); }
