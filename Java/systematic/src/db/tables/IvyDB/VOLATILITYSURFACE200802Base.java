...
public class VOLATILITYSURFACE200802Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200802Base T_VOLATILITY_SURFACE_2008_02 = new VOLATILITYSURFACE200802Base("VOLATILITY_SURFACE_2008_02base");

    public VOLATILITYSURFACE200802Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2008_02", alias); }
