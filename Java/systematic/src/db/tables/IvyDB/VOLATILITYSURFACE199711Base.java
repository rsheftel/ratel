...
public class VOLATILITYSURFACE199711Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199711Base T_VOLATILITY_SURFACE_1997_11 = new VOLATILITYSURFACE199711Base("VOLATILITY_SURFACE_1997_11base");

    public VOLATILITYSURFACE199711Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_11", alias); }
