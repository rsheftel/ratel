...
public class VOLATILITYSURFACE200311Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200311Base T_VOLATILITY_SURFACE_2003_11 = new VOLATILITYSURFACE200311Base("VOLATILITY_SURFACE_2003_11base");

    public VOLATILITYSURFACE200311Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_11", alias); }
