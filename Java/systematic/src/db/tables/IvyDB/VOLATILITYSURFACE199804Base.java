...
public class VOLATILITYSURFACE199804Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199804Base T_VOLATILITY_SURFACE_1998_04 = new VOLATILITYSURFACE199804Base("VOLATILITY_SURFACE_1998_04base");

    public VOLATILITYSURFACE199804Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_04", alias); }
