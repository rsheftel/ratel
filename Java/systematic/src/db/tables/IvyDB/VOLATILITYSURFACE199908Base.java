...
public class VOLATILITYSURFACE199908Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199908Base T_VOLATILITY_SURFACE_1999_08 = new VOLATILITYSURFACE199908Base("VOLATILITY_SURFACE_1999_08base");

    public VOLATILITYSURFACE199908Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_08", alias); }
