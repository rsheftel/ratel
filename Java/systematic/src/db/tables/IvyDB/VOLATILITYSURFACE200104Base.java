...
public class VOLATILITYSURFACE200104Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200104Base T_VOLATILITY_SURFACE_2001_04 = new VOLATILITYSURFACE200104Base("VOLATILITY_SURFACE_2001_04base");

    public VOLATILITYSURFACE200104Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_04", alias); }
