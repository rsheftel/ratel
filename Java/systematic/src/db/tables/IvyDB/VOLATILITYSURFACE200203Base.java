...
public class VOLATILITYSURFACE200203Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200203Base T_VOLATILITY_SURFACE_2002_03 = new VOLATILITYSURFACE200203Base("VOLATILITY_SURFACE_2002_03base");

    public VOLATILITYSURFACE200203Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_03", alias); }
