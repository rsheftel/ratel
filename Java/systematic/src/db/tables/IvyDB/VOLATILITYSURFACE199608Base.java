...
public class VOLATILITYSURFACE199608Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199608Base T_VOLATILITY_SURFACE_1996_08 = new VOLATILITYSURFACE199608Base("VOLATILITY_SURFACE_1996_08base");

    public VOLATILITYSURFACE199608Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1996_08", alias); }
