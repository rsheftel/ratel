...
public class SECURITYPRICEBase extends Table {

    private static final long serialVersionUID = 1L;    public static final SECURITYPRICEBase T_SECURITY_PRICE = new SECURITYPRICEBase("SECURITY_PRICEbase");

    public SECURITYPRICEBase(String alias) { super("IvyDB..SECURITY_PRICE", alias); }
