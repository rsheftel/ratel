...
public class VOLATILITYSURFACE200608Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200608Base T_VOLATILITY_SURFACE_2006_08 = new VOLATILITYSURFACE200608Base("VOLATILITY_SURFACE_2006_08base");

    public VOLATILITYSURFACE200608Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_08", alias); }
