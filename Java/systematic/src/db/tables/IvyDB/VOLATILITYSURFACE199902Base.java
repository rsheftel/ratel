...
public class VOLATILITYSURFACE199902Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199902Base T_VOLATILITY_SURFACE_1999_02 = new VOLATILITYSURFACE199902Base("VOLATILITY_SURFACE_1999_02base");

    public VOLATILITYSURFACE199902Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_02", alias); }
