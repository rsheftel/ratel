...
public class OPTIONPRICETEMPBase extends Table {

    private static final long serialVersionUID = 1L;    public static final OPTIONPRICETEMPBase T_OPTION_PRICE_TEMP = new OPTIONPRICETEMPBase("OPTION_PRICE_TEMPbase");

    public OPTIONPRICETEMPBase(String alias) { super("IvyDB..OPTION_PRICE_TEMP", alias); }
