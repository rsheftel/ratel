...
public class VOLATILITYSURFACE200112Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200112Base T_VOLATILITY_SURFACE_2001_12 = new VOLATILITYSURFACE200112Base("VOLATILITY_SURFACE_2001_12base");

    public VOLATILITYSURFACE200112Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_12", alias); }
