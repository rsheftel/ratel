...
public class VOLATILITYSURFACE199901Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199901Base T_VOLATILITY_SURFACE_1999_01 = new VOLATILITYSURFACE199901Base("VOLATILITY_SURFACE_1999_01base");

    public VOLATILITYSURFACE199901Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_01", alias); }
