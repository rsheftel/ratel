...
public class VOLATILITYSURFACE200305Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200305Base T_VOLATILITY_SURFACE_2003_05 = new VOLATILITYSURFACE200305Base("VOLATILITY_SURFACE_2003_05base");

    public VOLATILITYSURFACE200305Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_05", alias); }
