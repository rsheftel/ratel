...
public class VOLATILITYSURFACE200309Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200309Base T_VOLATILITY_SURFACE_2003_09 = new VOLATILITYSURFACE200309Base("VOLATILITY_SURFACE_2003_09base");

    public VOLATILITYSURFACE200309Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_09", alias); }
