...
public class VOLATILITYSURFACE199911Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199911Base T_VOLATILITY_SURFACE_1999_11 = new VOLATILITYSURFACE199911Base("VOLATILITY_SURFACE_1999_11base");

    public VOLATILITYSURFACE199911Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_11", alias); }
