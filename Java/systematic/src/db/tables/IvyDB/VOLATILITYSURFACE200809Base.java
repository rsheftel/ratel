...
public class VOLATILITYSURFACE200809Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200809Base T_VOLATILITY_SURFACE_2008_09 = new VOLATILITYSURFACE200809Base("VOLATILITY_SURFACE_2008_09base");

    public VOLATILITYSURFACE200809Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2008_09", alias); }
