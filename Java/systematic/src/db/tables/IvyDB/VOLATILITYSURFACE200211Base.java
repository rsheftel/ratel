...
public class VOLATILITYSURFACE200211Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200211Base T_VOLATILITY_SURFACE_2002_11 = new VOLATILITYSURFACE200211Base("VOLATILITY_SURFACE_2002_11base");

    public VOLATILITYSURFACE200211Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_11", alias); }
