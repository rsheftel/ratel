...
public class VOLATILITYSURFACE199805Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199805Base T_VOLATILITY_SURFACE_1998_05 = new VOLATILITYSURFACE199805Base("VOLATILITY_SURFACE_1998_05base");

    public VOLATILITYSURFACE199805Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_05", alias); }
