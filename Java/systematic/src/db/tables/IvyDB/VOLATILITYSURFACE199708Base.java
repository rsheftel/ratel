...
public class VOLATILITYSURFACE199708Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199708Base T_VOLATILITY_SURFACE_1997_08 = new VOLATILITYSURFACE199708Base("VOLATILITY_SURFACE_1997_08base");

    public VOLATILITYSURFACE199708Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_08", alias); }
