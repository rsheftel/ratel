...
public class VOLATILITYSURFACE199906Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199906Base T_VOLATILITY_SURFACE_1999_06 = new VOLATILITYSURFACE199906Base("VOLATILITY_SURFACE_1999_06base");

    public VOLATILITYSURFACE199906Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_06", alias); }
