...
public class VOLATILITYSURFACE200511Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200511Base T_VOLATILITY_SURFACE_2005_11 = new VOLATILITYSURFACE200511Base("VOLATILITY_SURFACE_2005_11base");

    public VOLATILITYSURFACE200511Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_11", alias); }
