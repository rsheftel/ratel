...
public class VOLATILITYSURFACE200009Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200009Base T_VOLATILITY_SURFACE_2000_09 = new VOLATILITYSURFACE200009Base("VOLATILITY_SURFACE_2000_09base");

    public VOLATILITYSURFACE200009Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2000_09", alias); }
