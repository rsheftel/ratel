...
public class VOLATILITYSURFACE200507Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200507Base T_VOLATILITY_SURFACE_2005_07 = new VOLATILITYSURFACE200507Base("VOLATILITY_SURFACE_2005_07base");

    public VOLATILITYSURFACE200507Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_07", alias); }
