...
public class VOLATILITYSURFACE200201Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200201Base T_VOLATILITY_SURFACE_2002_01 = new VOLATILITYSURFACE200201Base("VOLATILITY_SURFACE_2002_01base");

    public VOLATILITYSURFACE200201Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_01", alias); }
