...
public class VOLATILITYSURFACE200612Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200612Base T_VOLATILITY_SURFACE_2006_12 = new VOLATILITYSURFACE200612Base("VOLATILITY_SURFACE_2006_12base");

    public VOLATILITYSURFACE200612Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_12", alias); }
