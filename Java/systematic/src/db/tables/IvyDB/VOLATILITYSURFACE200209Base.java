...
public class VOLATILITYSURFACE200209Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200209Base T_VOLATILITY_SURFACE_2002_09 = new VOLATILITYSURFACE200209Base("VOLATILITY_SURFACE_2002_09base");

    public VOLATILITYSURFACE200209Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_09", alias); }
