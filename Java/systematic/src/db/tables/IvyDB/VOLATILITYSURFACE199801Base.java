...
public class VOLATILITYSURFACE199801Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199801Base T_VOLATILITY_SURFACE_1998_01 = new VOLATILITYSURFACE199801Base("VOLATILITY_SURFACE_1998_01base");

    public VOLATILITYSURFACE199801Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_01", alias); }
