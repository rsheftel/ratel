...
public class VOLATILITYSURFACE200805Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200805Base T_VOLATILITY_SURFACE_2008_05 = new VOLATILITYSURFACE200805Base("VOLATILITY_SURFACE_2008_05base");

    public VOLATILITYSURFACE200805Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2008_05", alias); }
