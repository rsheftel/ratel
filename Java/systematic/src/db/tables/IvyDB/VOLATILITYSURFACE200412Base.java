...
public class VOLATILITYSURFACE200412Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200412Base T_VOLATILITY_SURFACE_2004_12 = new VOLATILITYSURFACE200412Base("VOLATILITY_SURFACE_2004_12base");

    public VOLATILITYSURFACE200412Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_12", alias); }
