...
public class VOLATILITYSURFACE200510Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200510Base T_VOLATILITY_SURFACE_2005_10 = new VOLATILITYSURFACE200510Base("VOLATILITY_SURFACE_2005_10base");

    public VOLATILITYSURFACE200510Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_10", alias); }
