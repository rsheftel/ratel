...
public class VOLATILITYSURFACE200801Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200801Base T_VOLATILITY_SURFACE_2008_01 = new VOLATILITYSURFACE200801Base("VOLATILITY_SURFACE_2008_01base");

    public VOLATILITYSURFACE200801Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2008_01", alias); }
