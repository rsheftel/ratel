...
public class VOLATILITYSURFACE200012Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200012Base T_VOLATILITY_SURFACE_2000_12 = new VOLATILITYSURFACE200012Base("VOLATILITY_SURFACE_2000_12base");

    public VOLATILITYSURFACE200012Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2000_12", alias); }
