...
public class VOLATILITYSURFACE200410Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200410Base T_VOLATILITY_SURFACE_2004_10 = new VOLATILITYSURFACE200410Base("VOLATILITY_SURFACE_2004_10base");

    public VOLATILITYSURFACE200410Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_10", alias); }
