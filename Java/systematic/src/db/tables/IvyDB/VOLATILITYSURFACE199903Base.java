...
public class VOLATILITYSURFACE199903Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199903Base T_VOLATILITY_SURFACE_1999_03 = new VOLATILITYSURFACE199903Base("VOLATILITY_SURFACE_1999_03base");

    public VOLATILITYSURFACE199903Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_03", alias); }
