...
public class VOLATILITYSURFACE200005Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200005Base T_VOLATILITY_SURFACE_2000_05 = new VOLATILITYSURFACE200005Base("VOLATILITY_SURFACE_2000_05base");

    public VOLATILITYSURFACE200005Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2000_05", alias); }
