...
public class VOLATILITYSURFACE200603Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200603Base T_VOLATILITY_SURFACE_2006_03 = new VOLATILITYSURFACE200603Base("VOLATILITY_SURFACE_2006_03base");

    public VOLATILITYSURFACE200603Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_03", alias); }
