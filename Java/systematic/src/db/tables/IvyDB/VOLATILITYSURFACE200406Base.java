...
public class VOLATILITYSURFACE200406Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200406Base T_VOLATILITY_SURFACE_2004_06 = new VOLATILITYSURFACE200406Base("VOLATILITY_SURFACE_2004_06base");

    public VOLATILITYSURFACE200406Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_06", alias); }
