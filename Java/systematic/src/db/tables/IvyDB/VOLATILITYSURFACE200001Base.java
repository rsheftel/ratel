...
public class VOLATILITYSURFACE200001Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200001Base T_VOLATILITY_SURFACE_2000_01 = new VOLATILITYSURFACE200001Base("VOLATILITY_SURFACE_2000_01base");

    public VOLATILITYSURFACE200001Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2000_01", alias); }
