...
public class VOLATILITYSURFACE200107Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200107Base T_VOLATILITY_SURFACE_2001_07 = new VOLATILITYSURFACE200107Base("VOLATILITY_SURFACE_2001_07base");

    public VOLATILITYSURFACE200107Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_07", alias); }
