...
public class VOLATILITYSURFACE199806Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199806Base T_VOLATILITY_SURFACE_1998_06 = new VOLATILITYSURFACE199806Base("VOLATILITY_SURFACE_1998_06base");

    public VOLATILITYSURFACE199806Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_06", alias); }
