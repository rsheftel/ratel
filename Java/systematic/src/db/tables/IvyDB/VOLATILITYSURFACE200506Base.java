...
public class VOLATILITYSURFACE200506Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200506Base T_VOLATILITY_SURFACE_2005_06 = new VOLATILITYSURFACE200506Base("VOLATILITY_SURFACE_2005_06base");

    public VOLATILITYSURFACE200506Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_06", alias); }
