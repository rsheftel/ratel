...
public class VOLATILITYSURFACE199710Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199710Base T_VOLATILITY_SURFACE_1997_10 = new VOLATILITYSURFACE199710Base("VOLATILITY_SURFACE_1997_10base");

    public VOLATILITYSURFACE199710Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_10", alias); }
