...
public class VOLATILITYSURFACE199706Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199706Base T_VOLATILITY_SURFACE_1997_06 = new VOLATILITYSURFACE199706Base("VOLATILITY_SURFACE_1997_06base");

    public VOLATILITYSURFACE199706Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_06", alias); }
