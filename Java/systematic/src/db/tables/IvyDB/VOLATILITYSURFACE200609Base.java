...
public class VOLATILITYSURFACE200609Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200609Base T_VOLATILITY_SURFACE_2006_09 = new VOLATILITYSURFACE200609Base("VOLATILITY_SURFACE_2006_09base");

    public VOLATILITYSURFACE200609Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_09", alias); }
