...
public class VOLATILITYSURFACE199703Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199703Base T_VOLATILITY_SURFACE_1997_03 = new VOLATILITYSURFACE199703Base("VOLATILITY_SURFACE_1997_03base");

    public VOLATILITYSURFACE199703Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_03", alias); }
