...
public class VOLATILITYSURFACE200505Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200505Base T_VOLATILITY_SURFACE_2005_05 = new VOLATILITYSURFACE200505Base("VOLATILITY_SURFACE_2005_05base");

    public VOLATILITYSURFACE200505Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_05", alias); }
