...
public class VOLATILITYSURFACE200610Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200610Base T_VOLATILITY_SURFACE_2006_10 = new VOLATILITYSURFACE200610Base("VOLATILITY_SURFACE_2006_10base");

    public VOLATILITYSURFACE200610Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_10", alias); }
