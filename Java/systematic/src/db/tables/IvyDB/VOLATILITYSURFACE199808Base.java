...
public class VOLATILITYSURFACE199808Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199808Base T_VOLATILITY_SURFACE_1998_08 = new VOLATILITYSURFACE199808Base("VOLATILITY_SURFACE_1998_08base");

    public VOLATILITYSURFACE199808Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_08", alias); }
