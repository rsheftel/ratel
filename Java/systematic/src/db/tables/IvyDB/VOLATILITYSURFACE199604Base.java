...
public class VOLATILITYSURFACE199604Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199604Base T_VOLATILITY_SURFACE_1996_04 = new VOLATILITYSURFACE199604Base("VOLATILITY_SURFACE_1996_04base");

    public VOLATILITYSURFACE199604Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1996_04", alias); }
