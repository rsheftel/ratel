...
public class VOLATILITYSURFACE200502Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200502Base T_VOLATILITY_SURFACE_2005_02 = new VOLATILITYSURFACE200502Base("VOLATILITY_SURFACE_2005_02base");

    public VOLATILITYSURFACE200502Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_02", alias); }
