...
public class VOLATILITYSURFACE200011Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200011Base T_VOLATILITY_SURFACE_2000_11 = new VOLATILITYSURFACE200011Base("VOLATILITY_SURFACE_2000_11base");

    public VOLATILITYSURFACE200011Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2000_11", alias); }
