...
public class VOLATILITYSURFACE200804Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200804Base T_VOLATILITY_SURFACE_2008_04 = new VOLATILITYSURFACE200804Base("VOLATILITY_SURFACE_2008_04base");

    public VOLATILITYSURFACE200804Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2008_04", alias); }
