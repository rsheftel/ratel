...
public class VOLATILITYSURFACE200304Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200304Base T_VOLATILITY_SURFACE_2003_04 = new VOLATILITYSURFACE200304Base("VOLATILITY_SURFACE_2003_04base");

    public VOLATILITYSURFACE200304Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_04", alias); }
