...
public class VOLATILITYSURFACE199707Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199707Base T_VOLATILITY_SURFACE_1997_07 = new VOLATILITYSURFACE199707Base("VOLATILITY_SURFACE_1997_07base");

    public VOLATILITYSURFACE199707Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_07", alias); }
