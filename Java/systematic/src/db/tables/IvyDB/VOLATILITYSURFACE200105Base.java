...
public class VOLATILITYSURFACE200105Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200105Base T_VOLATILITY_SURFACE_2001_05 = new VOLATILITYSURFACE200105Base("VOLATILITY_SURFACE_2001_05base");

    public VOLATILITYSURFACE200105Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_05", alias); }
