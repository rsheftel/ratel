...
public class VOLATILITYSURFACE199912Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199912Base T_VOLATILITY_SURFACE_1999_12 = new VOLATILITYSURFACE199912Base("VOLATILITY_SURFACE_1999_12base");

    public VOLATILITYSURFACE199912Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_12", alias); }
