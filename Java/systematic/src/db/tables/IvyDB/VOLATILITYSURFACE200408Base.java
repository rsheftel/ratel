...
public class VOLATILITYSURFACE200408Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200408Base T_VOLATILITY_SURFACE_2004_08 = new VOLATILITYSURFACE200408Base("VOLATILITY_SURFACE_2004_08base");

    public VOLATILITYSURFACE200408Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_08", alias); }
