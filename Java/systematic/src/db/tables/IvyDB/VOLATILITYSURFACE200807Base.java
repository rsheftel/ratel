...
public class VOLATILITYSURFACE200807Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200807Base T_VOLATILITY_SURFACE_2008_07 = new VOLATILITYSURFACE200807Base("VOLATILITY_SURFACE_2008_07base");

    public VOLATILITYSURFACE200807Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2008_07", alias); }
