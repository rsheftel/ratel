...
public class VOLATILITYSURFACE200006Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200006Base T_VOLATILITY_SURFACE_2000_06 = new VOLATILITYSURFACE200006Base("VOLATILITY_SURFACE_2000_06base");

    public VOLATILITYSURFACE200006Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2000_06", alias); }
