...
public class VOLATILITYSURFACE199701Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199701Base T_VOLATILITY_SURFACE_1997_01 = new VOLATILITYSURFACE199701Base("VOLATILITY_SURFACE_1997_01base");

    public VOLATILITYSURFACE199701Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_01", alias); }
