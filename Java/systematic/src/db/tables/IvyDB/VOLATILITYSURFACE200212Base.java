...
public class VOLATILITYSURFACE200212Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200212Base T_VOLATILITY_SURFACE_2002_12 = new VOLATILITYSURFACE200212Base("VOLATILITY_SURFACE_2002_12base");

    public VOLATILITYSURFACE200212Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_12", alias); }
