...
public class VOLATILITYSURFACE199612Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199612Base T_VOLATILITY_SURFACE_1996_12 = new VOLATILITYSURFACE199612Base("VOLATILITY_SURFACE_1996_12base");

    public VOLATILITYSURFACE199612Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1996_12", alias); }
