...
public class VOLATILITYSURFACE200509Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200509Base T_VOLATILITY_SURFACE_2005_09 = new VOLATILITYSURFACE200509Base("VOLATILITY_SURFACE_2005_09base");

    public VOLATILITYSURFACE200509Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_09", alias); }
