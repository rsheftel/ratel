...
public class VOLATILITYSURFACE200704Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200704Base T_VOLATILITY_SURFACE_2007_04 = new VOLATILITYSURFACE200704Base("VOLATILITY_SURFACE_2007_04base");

    public VOLATILITYSURFACE200704Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_04", alias); }
