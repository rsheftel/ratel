...
public class STDOPTIONPRICEBase extends Table {

    private static final long serialVersionUID = 1L;    public static final STDOPTIONPRICEBase T_STD_OPTION_PRICE = new STDOPTIONPRICEBase("STD_OPTION_PRICEbase");

    public STDOPTIONPRICEBase(String alias) { super("IvyDB..STD_OPTION_PRICE", alias); }
