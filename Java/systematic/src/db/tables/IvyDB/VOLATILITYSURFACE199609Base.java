...
public class VOLATILITYSURFACE199609Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199609Base T_VOLATILITY_SURFACE_1996_09 = new VOLATILITYSURFACE199609Base("VOLATILITY_SURFACE_1996_09base");

    public VOLATILITYSURFACE199609Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1996_09", alias); }
