...
public class VOLATILITYSURFACE200706Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200706Base T_VOLATILITY_SURFACE_2007_06 = new VOLATILITYSURFACE200706Base("VOLATILITY_SURFACE_2007_06base");

    public VOLATILITYSURFACE200706Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_06", alias); }
