...
public class VOLATILITYSURFACE200407Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200407Base T_VOLATILITY_SURFACE_2004_07 = new VOLATILITYSURFACE200407Base("VOLATILITY_SURFACE_2004_07base");

    public VOLATILITYSURFACE200407Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_07", alias); }
