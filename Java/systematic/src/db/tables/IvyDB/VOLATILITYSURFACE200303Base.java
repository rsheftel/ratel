...
public class VOLATILITYSURFACE200303Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200303Base T_VOLATILITY_SURFACE_2003_03 = new VOLATILITYSURFACE200303Base("VOLATILITY_SURFACE_2003_03base");

    public VOLATILITYSURFACE200303Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_03", alias); }
