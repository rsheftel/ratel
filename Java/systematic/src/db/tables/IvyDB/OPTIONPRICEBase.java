...
public class OPTIONPRICEBase extends Table {

    private static final long serialVersionUID = 1L;    public static final OPTIONPRICEBase T_OPTION_PRICE = new OPTIONPRICEBase("OPTION_PRICEbase");

    public OPTIONPRICEBase(String alias) { super("IvyDB..OPTION_PRICE", alias); }
