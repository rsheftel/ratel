...
public class VOLATILITYSURFACE200106Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200106Base T_VOLATILITY_SURFACE_2001_06 = new VOLATILITYSURFACE200106Base("VOLATILITY_SURFACE_2001_06base");

    public VOLATILITYSURFACE200106Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_06", alias); }
