...
public class VOLATILITYSURFACE200803Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200803Base T_VOLATILITY_SURFACE_2008_03 = new VOLATILITYSURFACE200803Base("VOLATILITY_SURFACE_2008_03base");

    public VOLATILITYSURFACE200803Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2008_03", alias); }
