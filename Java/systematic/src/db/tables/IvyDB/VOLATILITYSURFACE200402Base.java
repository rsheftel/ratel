...
public class VOLATILITYSURFACE200402Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200402Base T_VOLATILITY_SURFACE_2004_02 = new VOLATILITYSURFACE200402Base("VOLATILITY_SURFACE_2004_02base");

    public VOLATILITYSURFACE200402Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_02", alias); }
