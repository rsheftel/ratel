...
public class VOLATILITYSURFACE199704Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199704Base T_VOLATILITY_SURFACE_1997_04 = new VOLATILITYSURFACE199704Base("VOLATILITY_SURFACE_1997_04base");

    public VOLATILITYSURFACE199704Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1997_04", alias); }
