...
public class VOLATILITYSURFACE199907Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199907Base T_VOLATILITY_SURFACE_1999_07 = new VOLATILITYSURFACE199907Base("VOLATILITY_SURFACE_1999_07base");

    public VOLATILITYSURFACE199907Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_07", alias); }
