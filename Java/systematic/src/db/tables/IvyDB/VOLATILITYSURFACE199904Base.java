...
public class VOLATILITYSURFACE199904Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199904Base T_VOLATILITY_SURFACE_1999_04 = new VOLATILITYSURFACE199904Base("VOLATILITY_SURFACE_1999_04base");

    public VOLATILITYSURFACE199904Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_04", alias); }
