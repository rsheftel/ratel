...
public class VOLATILITYSURFACE200108Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200108Base T_VOLATILITY_SURFACE_2001_08 = new VOLATILITYSURFACE200108Base("VOLATILITY_SURFACE_2001_08base");

    public VOLATILITYSURFACE200108Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2001_08", alias); }
