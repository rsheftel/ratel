...
public class VOLATILITYSURFACE200306Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200306Base T_VOLATILITY_SURFACE_2003_06 = new VOLATILITYSURFACE200306Base("VOLATILITY_SURFACE_2003_06base");

    public VOLATILITYSURFACE200306Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_06", alias); }
