...
public class VOLATILITYSURFACE200604Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200604Base T_VOLATILITY_SURFACE_2006_04 = new VOLATILITYSURFACE200604Base("VOLATILITY_SURFACE_2006_04base");

    public VOLATILITYSURFACE200604Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_04", alias); }
