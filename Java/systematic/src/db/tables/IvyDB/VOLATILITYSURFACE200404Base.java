...
public class VOLATILITYSURFACE200404Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200404Base T_VOLATILITY_SURFACE_2004_04 = new VOLATILITYSURFACE200404Base("VOLATILITY_SURFACE_2004_04base");

    public VOLATILITYSURFACE200404Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_04", alias); }
