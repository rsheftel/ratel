...
public class VOLATILITYSURFACE200601Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200601Base T_VOLATILITY_SURFACE_2006_01 = new VOLATILITYSURFACE200601Base("VOLATILITY_SURFACE_2006_01base");

    public VOLATILITYSURFACE200601Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2006_01", alias); }
