...
public class VOLATILITYSURFACE199910Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199910Base T_VOLATILITY_SURFACE_1999_10 = new VOLATILITYSURFACE199910Base("VOLATILITY_SURFACE_1999_10base");

    public VOLATILITYSURFACE199910Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_10", alias); }
