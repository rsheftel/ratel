...
public class VOLATILITYSURFACE200310Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200310Base T_VOLATILITY_SURFACE_2003_10 = new VOLATILITYSURFACE200310Base("VOLATILITY_SURFACE_2003_10base");

    public VOLATILITYSURFACE200310Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_10", alias); }
