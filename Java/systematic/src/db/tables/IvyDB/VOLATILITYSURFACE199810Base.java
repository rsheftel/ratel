...
public class VOLATILITYSURFACE199810Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199810Base T_VOLATILITY_SURFACE_1998_10 = new VOLATILITYSURFACE199810Base("VOLATILITY_SURFACE_1998_10base");

    public VOLATILITYSURFACE199810Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1998_10", alias); }
