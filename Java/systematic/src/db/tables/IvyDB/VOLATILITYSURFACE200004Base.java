...
public class VOLATILITYSURFACE200004Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200004Base T_VOLATILITY_SURFACE_2000_04 = new VOLATILITYSURFACE200004Base("VOLATILITY_SURFACE_2000_04base");

    public VOLATILITYSURFACE200004Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2000_04", alias); }
