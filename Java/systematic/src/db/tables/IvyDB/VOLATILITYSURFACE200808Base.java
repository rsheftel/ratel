...
public class VOLATILITYSURFACE200808Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200808Base T_VOLATILITY_SURFACE_2008_08 = new VOLATILITYSURFACE200808Base("VOLATILITY_SURFACE_2008_08base");

    public VOLATILITYSURFACE200808Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2008_08", alias); }
