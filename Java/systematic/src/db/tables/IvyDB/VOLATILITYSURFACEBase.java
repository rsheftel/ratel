...
public class VOLATILITYSURFACEBase extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACEBase T_VOLATILITY_SURFACE = new VOLATILITYSURFACEBase("VOLATILITY_SURFACEbase");

    public VOLATILITYSURFACEBase(String alias) { super("IvyDB..VOLATILITY_SURFACE", alias); }
