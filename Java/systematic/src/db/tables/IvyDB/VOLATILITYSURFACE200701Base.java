...
public class VOLATILITYSURFACE200701Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200701Base T_VOLATILITY_SURFACE_2007_01 = new VOLATILITYSURFACE200701Base("VOLATILITY_SURFACE_2007_01base");

    public VOLATILITYSURFACE200701Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2007_01", alias); }
