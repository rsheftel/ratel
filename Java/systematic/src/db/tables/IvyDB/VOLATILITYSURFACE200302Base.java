...
public class VOLATILITYSURFACE200302Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200302Base T_VOLATILITY_SURFACE_2003_02 = new VOLATILITYSURFACE200302Base("VOLATILITY_SURFACE_2003_02base");

    public VOLATILITYSURFACE200302Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2003_02", alias); }
