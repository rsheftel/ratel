...
public class VOLATILITYSURFACE200411Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200411Base T_VOLATILITY_SURFACE_2004_11 = new VOLATILITYSURFACE200411Base("VOLATILITY_SURFACE_2004_11base");

    public VOLATILITYSURFACE200411Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_11", alias); }
