...
public class VOLATILITYSURFACE200206Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200206Base T_VOLATILITY_SURFACE_2002_06 = new VOLATILITYSURFACE200206Base("VOLATILITY_SURFACE_2002_06base");

    public VOLATILITYSURFACE200206Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2002_06", alias); }
