...
public class VOLATILITYSURFACE200512Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200512Base T_VOLATILITY_SURFACE_2005_12 = new VOLATILITYSURFACE200512Base("VOLATILITY_SURFACE_2005_12base");

    public VOLATILITYSURFACE200512Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2005_12", alias); }
