...
public class VOLATILITYSURFACE200409Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200409Base T_VOLATILITY_SURFACE_2004_09 = new VOLATILITYSURFACE200409Base("VOLATILITY_SURFACE_2004_09base");

    public VOLATILITYSURFACE200409Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_09", alias); }
