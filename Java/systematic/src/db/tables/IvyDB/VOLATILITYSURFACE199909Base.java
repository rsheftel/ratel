...
public class VOLATILITYSURFACE199909Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE199909Base T_VOLATILITY_SURFACE_1999_09 = new VOLATILITYSURFACE199909Base("VOLATILITY_SURFACE_1999_09base");

    public VOLATILITYSURFACE199909Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_1999_09", alias); }
