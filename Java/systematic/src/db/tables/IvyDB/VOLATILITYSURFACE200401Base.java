...
public class VOLATILITYSURFACE200401Base extends Table {

    private static final long serialVersionUID = 1L;    public static final VOLATILITYSURFACE200401Base T_VOLATILITY_SURFACE_2004_01 = new VOLATILITYSURFACE200401Base("VOLATILITY_SURFACE_2004_01base");

    public VOLATILITYSURFACE200401Base(String alias) { super("IvyDB..VOLATILITY_SURFACE_2004_01", alias); }
